...
class WalletAction extends  BaseAction
{
    ...
    public function  detail(){
       ...
       // $sql2 = "SELECT * FROM ". C('DB_PREFIX') . "fast_order as morder  WHERE morder.mer_id={$mer_id} AND morder.paid=1 ";
        $sql3 = "SELECT morder.* , u.nickname, u.avatar  FROM " . C('DB_PREFIX') . "fast_order as morder LEFT JOIN ".C('DB_PREFIX') . "user u ON morder.uid=u.uid WHERE morder.mer_id={$mer_id} AND morder.paid=1";
