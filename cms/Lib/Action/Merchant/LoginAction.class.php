...
//			$now_merchant = $database_merchant->field('`mer_id`')->field(true)->where($condition_merchant)->find();
			$now_merchant = $database_merchant->field('`mer_id`')->field(true)->where("name='%s'",array($_POST['name']))->find();
			if(!empty($now_merchant)){
...
//			$now_merchant = $database_merchant->field('`mer_id`')->field(true)->where($condition_merchant)->find();
			$now_merchant = $database_merchant->field('`mer_id`')->field(true)->where("email='%s'",array($_POST['email']))->find();
			if(!empty($now_merchant)){
...
//			$now_merchant = $database_merchant->field('`mer_id`')->field(true)->where($condition_merchant)->find();
			$now_merchant = $database_merchant->field('`mer_id`')->field(true)->where("phone='%s'",array($_POST['phone']))->find();
			if(!empty($now_merchant)){
