...
class WeixinResponseAction extends Action
{
            ...
            if ($keyword) {
                switch ($keyword['table']) {
                    ...
                    case 'Source_material':
                        ...
                        if(empty($image_text['url'])){
                            $image_text['url']="http://www.xiaonongding.com/wap.php?g=Wap&c=Article&a=index&imid=".$id;
                        }
                        $content = array();
                        $content[] = array(
                            $image_text['title'],
                            ...
                            htmlspecialchars_decode($image_text['url'])
                        );
    ...
    private function getImage($img) {
        return "http://www.xiaonongding.com".$img;
    }
