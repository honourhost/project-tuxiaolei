...
// 		return $t;
	...
	{
		//http://sunny.wei.cn/wap.php?g=Wap&c=Food&a=shop&token=81&mer_id=81&store_id=79&otherwc=1
		$t = array(
		array('module' => 'Home',		'linkcode' => str_replace('merchant.php', 'wap.php', U('Wap/Index/index', array('token' => $this->token), true, false, true)), 'name'=>'农场主页','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>$this->modules['Home'],'askeyword'=>1),
...
//		array('module' => 'Sell',		'linkcode'=>'','name'=>$this->modules['Food'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1) ,
...
//		array('module' => 'Coupon',		'linkcode'=>'','name'=>$this->modules['Coupon'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
		...
		array('module' => 'My',		'linkcode'=>str_replace('merchant.php', 'wap.php', U('Wap/My/index','', true, false, true)),'name'=>'我的','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>$this->modules['My'],'askeyword'=>1),
		array('module' => 'NewMy',		'linkcode'=>str_replace('merchant.php', 'wap.php', U('Wap/My/index_new','', true, false, true)),'name'=>'新我的','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>$this->modules['My'],'askeyword'=>1),
		);
...
//		}
	...
	public function Weidian()
	{
		...
		$request_url = "http://www.xiaonongding.com/api/store.php";
