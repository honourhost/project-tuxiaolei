...
class CommonAction extends Action
{
	...
	{
		if ((strpos($_SERVER['HTTP_HOST'], 'ymtq.com') === false) && (strpos($_SERVER['HTTP_HOST'], 'weihubao.com') === false) && (strpos($_SERVER['HTTP_HOST'], 'xiaonongding.com') === false) && (strpos($_SERVER['HTTP_HOST'], 'dazhongbanben.com') === false)) {
        ...
        $this->config['site_url'] ='http://tuxiaolei.xiaonongding.com';
