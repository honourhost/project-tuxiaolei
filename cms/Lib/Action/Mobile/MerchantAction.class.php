...
class MerchantAction extends BaseAction{
    ...
    public function getPicturesList(){
        ...
        where(array(C('DB_PREFIX')."merchant_detailmodule.mer_id"=>$mer_id,C('DB_PREFIX')."merchant_detailmodule.status"=>1))->order(C('DB_PREFIX')."merchant_detailmodule.sort asc")->select();
