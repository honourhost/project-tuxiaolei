...
// 		}
	...
	public function getOrderList(){
		...
		$group_order_list=D('Group_order')->alias("go")->field("go.price,go.last_time,u.nickname,u.avatar")->join(C('DB_PREFIX')."user u ON go.uid=u.uid")->where($where)->limit($p->firstRow.','.$p->listRows)->select();
