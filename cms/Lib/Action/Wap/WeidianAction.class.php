...
{
    public $weidian_wap_url = "http://d.qinqingsong.com/wap/";//"http://d.qinqingsong.com/wap/";
    public $weidian_api_url = "http://d.qinqingsong.com/api/";//"http://d.qinqingsong.com/api/";
	...
	public function getImUrl()
	{
		if ($_GET['token'] && (true == $_GET['wecha_id'])) {
			...
			$kf_url = 'http://im-link.winworlds.cn/?app_id=' . $this->config['im_appid'] . '&openid=' . $now_user['openid'] . '&key=' . $key . '#serviceList_' . $_GET['token'];
			redirect($kf_url);
		}
		else {
