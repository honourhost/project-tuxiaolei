...
//                "link"=>array("platform"=>"good","url"=>$cateparent["cat_group_id"],"id"=>$cateparent["cat_group_id"],"title"=>$cateparent["cat_name"],"canjump"=>empty($cateparent["cat_group_id"])?0:1),"items"=>array(0=>array("title"=>$cateparent["cat_name"],"image"=>$cateparent["cat_pic"],
//                    "link"=>array("platform"=>"catlist","url"=>$cateparent["ccid"],"id"=>$cateparent["ccid"],"title"=>$cateparent["cat_name"]))));


                        $dataend[0]=array("styleID"=>"banner_01","header"=>0,"title"=>$cateparent["cat_name"],"subtitle"=>$cateparent["cat_desc"],"image"=>$cateparent["cat_pic"],
                "link"=>array("platform"=>"good","url"=>$cateparent["cat_group_id"],"id"=>$cateparent["cat_group_id"],"title"=>$cateparent["cat_name"],"canjump"=>empty($cateparent["cat_group_id"])?0:1),"items"=>array(0=>array("title"=>$cateparent["cat_name"],"image"=>$cateparent["cat_pic"],
                    "link"=>array("platform"=>"good","url"=>$cateparent["cat_group_id"],"id"=>$cateparent["cat_group_id"],"title"=>$cateparent["cat_name"],"canjump"=>empty($cateparent["cat_group_id"])?0:1))));
    ...
    public function  categoods(){
      ...
      //  echo  D()->getLastSql();die;
        ...
        $conditionwhere=" cat_id = ".$cid." AND is_group_buy = 0 AND begin_time < ".$_SERVER['REQUEST_TIME']." AND end_time > ".$_SERVER['REQUEST_TIME']." AND status = 1 AND type = 1 AND group_id <> 3428 ";
