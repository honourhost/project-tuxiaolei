        ...
        <dl class="list" style="margin-top:0px;">
		    <dd>
				<ul class="orderindex">
					...
					<li><a href="<?php echo U('My/group_order_list',array('status'=>233));?>" class="react <?php if($_GET['status'] == '233'): ?>hover<?php endif; ?>">
						<i class="text-icon">⌹</i>
						<span>拼团订单</span>
					</a>
					</li>
			                    ...
			                    <div class="dealcard-block-right">
			                        ...
			                        <weak>
			                        	...
			                        	<?php elseif(empty($vo['status'])): ?>
			                        		<?php if($vo['tuan_type'] == '2'): ?><a class="btn btn-weak color-gray">已付款</a>
			                        		<?php else: ?>
			                        		<a class="btn btn-weak color-gray">未消费</a><?php endif; ?>
			                        	<?php elseif($vo['status'] == '1'): ?>
			                        		<?php if($vo['user_confirm']==0): ?><a class="btn btn-weak" href="<?php echo U('My/group_feedback',array('order_id'=>$vo['order_id']));?>">确认收货</a>
												<?php else: ?>
												<a class="btn btn-weak" href="<?php echo U('My/group_feedback',array('order_id'=>$vo['order_id']));?>">去评价</a><?php endif; ?>
