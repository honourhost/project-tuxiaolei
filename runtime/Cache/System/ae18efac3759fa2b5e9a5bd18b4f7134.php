...
<div class="mainbox">
    <div id="nav" class="mainnav_title">
        <ul>
            <a href="<?php echo U('Distribution/index');?>" class="on">分销权限用户列表</a>
            <a href="<?php echo U('Distribution/add');?>">添加新的分销用户</a>
        </ul>
    </div>
        ...
        <div class="table-list">
            <table width="100%" cellspacing="0">
                ...
                <?php if(is_array($persons)): if(is_array($persons)): $i = 0; $__LIST__ = $persons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td  class="textcenter"><?php echo ($vo["user_id"]); ?></td>
                            <td  class="textcenter"><?php echo ($vo["distribution_id"]); ?></td>
