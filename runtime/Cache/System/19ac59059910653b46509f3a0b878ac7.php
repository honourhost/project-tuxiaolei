...
<div class="mainbox">
    ...
    <table class="search_table" width="100%">
        <tr>
            <td>
                <form action="<?php echo U('Group/lottery_pin_order');?>" method="get">
        ...
        <div class="table-list">
            ...
            <table width="100%" cellspacing="0">
                ...
                <?php if(is_array($order_list)): if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php if($vo['pinnickname']): ?>团长昵称:<?php echo ($vo["pinnickname"]); ?></br><?php endif; ?>中奖用户名：<?php echo ($vo["nickname"]); ?><br/>订单手机号：<?php echo ($vo["group_phone"]); ?></td>
                            <td>
