 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<form id="myform" method="post" action="<?php echo U('Merchant/amend');?>" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">商户市场负责人</th>
				<td><select name="marketer_id">
					<?php if(is_array($marketers)): $index = 0; $__LIST__ = $marketers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$marketer): $mod = ($index % 2 );++$index; if($marketer["id"] == $merchant["marketer_id"] ): ?><option value="<?php echo ($marketer["id"]); ?>" selected="selected"><?php echo ($marketer["name"]); ?></option>
							<?php else: ?>
							<option value="<?php echo ($marketer["id"]); ?>" ><?php echo ($marketer["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
					</select></td>
			</tr>
			<tr>
				<th width="80">商户状态</th>
