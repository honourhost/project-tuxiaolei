	...
	<body width="100%" <?php if($bg_color): ?>style="background:<?php echo ($bg_color); ?>;"<?php endif; ?>>
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					<a href="<?php echo U('Footer/index');?>" class="on">文章管理</a>|
					<a href="javascript:void(0);" onclick="window.top.artiframe('<?php echo U('Footer/add');?>','添加导航',800,460,true,false,false,addbtn,'add',true);">添加文章</a>
				</ul>
			</div>
