					...
					<table width="100%" cellspacing="0">
						...
						<tbody>
							<?php if(is_array($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td style="width:10%;"><?php echo ($vo["key"]); ?></td>
										<td style="width:10%;"><?php echo ($vo["title"]); ?></td>
										<td style="width:20%;word-wrap:break-word;word-break:break-all;"><?php echo ($vo["info"]); ?></td>
										<td style="width:15%;"><img alt="" src="<?php echo ($vo["pic"]); ?>" style="width:60px;height:50px;"></td>
										<td style="word-wrap:break-word;word-break:break-all;width:20%;"><?php echo ($vo["url"]); ?></td>
