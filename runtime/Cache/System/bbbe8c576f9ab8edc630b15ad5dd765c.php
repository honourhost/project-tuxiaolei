...
<div class="mainbox">
    <div id="nav" class="mainnav_title">
        <ul>
                <a href="<?php echo U('App/add');?>">添加新版本</a>
        </ul>
    </div>
    <form name="myform" id="myform" action="" method="post">
        <div class="table-list">
            <table width="100%" cellspacing="0">
                ...
                <tbody>
                <?php if(is_array($apps)): if(is_array($apps)): $i = 0; $__LIST__ = $apps;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo["id"]); ?></td>
                            <td><?php echo ($vo["name"]); ?></td>
                            <td><?php echo ($vo["file_id"]); ?></td>
                            <td><?php echo date("Y-m-d H:i:s",$vo['create_time']); ?></td>
                             <td class="textcenter"><?php echo ($vo["version_no"]); ?></td>
                            <td class="textcenter"><?php echo ($vo["version_detail"]); ?></td>
                            <td class="textcenter"><a href="<?php echo U('App/delete',array('id'=>$vo['id']));?>">删除</a></td>
