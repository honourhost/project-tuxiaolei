					...
					<div class="tab-content">
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<?php if($categories): ?><div class="form-group">
									<label class="col-sm-1"><label for="text_cat">图文分类</label></label>
									<select name="cat_id">
										<?php if(is_array($categories)): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i; if($cat['id'] == $image_text['cat_id']): ?><option value="<?php echo ($cat["id"]); ?>" selected><?php echo ($cat["name"]); ?></option>
										<?php else: ?>
								...
								<div class="form-group">
									...
									<textarea class="col-sm-3" id="content" name="content" style="width: 600px; height: 900px; display: none;"><?php echo ($image_text['content']); ?></textarea>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">视频vid</label></label>
									<input class="col-sm-3" name="video_url" id="video_url" type="text" value="<?php echo ($image_text['video_url']); ?>"/>请填写腾讯视频的vid</br></br>　
									示例：<img width="50%" height="100%" src="./upload/merchant/no/tenvideo.jpg">
								</div>
...
<link rel="stylesheet" href="<?php echo ($static_public); ?>kindeditor2/themes/default/default.css">
