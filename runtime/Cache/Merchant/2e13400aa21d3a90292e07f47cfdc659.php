    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="<?php echo U('Jicai/index');?>">集采管理</a>
            </li>
                            ...
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jicaitype" class="col-sm-1">
                                        <?php if(is_array($jicaicates)): $i = 0; $__LIST__ = $jicaicates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jicaicate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($jicaicate["sort_id"]); ?>"><?php echo ($jicaicate["sort_name"]); ?>
                        ...
                        <div id="txtnum" class="tab-pane">
                            ...
                            <div class="form-group">
                                ...
                                <input class="col-sm-3" name="remarks" type="text"
                                       value="<?php echo ($now_group["remarks"]); ?>"><span class="form_tips">特卖备注信息</span>
                            </div>
                        </div>
...
<script type="text/javascript">
    KindEditor.ready(function (K) {
        ...
        K('#J_selectImage').click(function () {
            ...
            editor.uploadJson = "<?php echo U('Jicai/ajax_upload_pic');?>";
        ...
        $('#add_form').submit(function () {
            ...
            $.post("<?php echo U('Jicai/add');?>", $('#add_form').serialize(), function (result) {
                if (result.status == 1) {
                    alert(result.info);
                    window.location.href = "<?php echo U('Jicai/index');?>";
                } else {
                    alert(result.info);
                }
    ...
    function deleteImage(path, obj) {
        $.post("<?php echo U('Jicai/ajax_del_pic');?>", {path: path});
