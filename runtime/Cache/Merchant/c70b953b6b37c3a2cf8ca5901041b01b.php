            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="breadcrumbs-price">
						<span>
							<a href="<?php echo U('Crowdcash/getCash');?>" class="btn btn-success">立即提现</a>
						</span>
                        <h3>累计成功提现：<b><?php echo ($allGetCash); ?></b>元</h3>
                        <h3>可提现金额：<b><?php echo round($totalmoney-$allGetCash-$devisionmoney,2);?></b>元</h3>
                    </div>
                                ...
                                <div class="grid-view">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php if($cash_list): if(is_array($cash_list)): $i = 0; $__LIST__ = $cash_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
                                                    ...
                                                    <td><?php if($vo['cash_time']): echo date("Y-m-d H:i:s",$vo['cash_time']); else: ?>还没有进行处理的申请<?php endif; ?></td>
                                                    <td><?php if($vo['status']==1): ?>提现成功<?php elseif($vo['status']==2): ?>提现被驳回<?php else: ?>正在申请中<?php endif; ?></td>
