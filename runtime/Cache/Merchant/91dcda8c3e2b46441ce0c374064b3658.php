                    ...
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <td style="text-align:center;">
                                <?php if($vo['group_lock'] == 0): ?><a style="width: 60px;" class="label label-sm label-info" title="编辑" href="<?php echo U('Jicai/edit',array('group_id'=>$vo['group_id']));?>">编辑</a><?php endif; ?>
                                &nbsp;<a style="width: 60px;" class="label label-sm label-info" title="订单列表" href="<?php echo U('Jicai/order_list',array('group_id'=>$vo['group_id']));?>">订单列表</a>


                            </td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php else: ?>
                            <tr class="odd"><td class="button-column" colspan="11" >您没有添加过集采！</td></tr><?php endif; ?>
                            </tbody>
                        </table>
                        <?php echo ($pagebar); ?>
                    </div>
...
<script type="text/javascript">
    function CreateShop(){
        window.location.href = "<?php echo U('Jicai/add');?>";
    }
    $(function(){
