										...
										<div class="grid-view">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <tr>
                                                        <td>统计总数</td>
                                                        <td><?php echo ($StaticAll["follow_num_all"]); ?></td>
                                                        <td><?php echo ($StaticAll["img_num_all"]); ?></td>
                                                        <td><?php echo ($StaticAll["website_hits_all"]); ?></td>
                                                    </tr>
										...
										<div class="grid-view">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <tr>
                                                        <td>统计总数</td>
                                                        <td><?php echo ($StaticAll["group_hits_all"]); ?></td>
                                                        <td><?php echo ($StaticAll["group_buy_money_all"]); ?></td>
                                                        <td>￥<?php echo ($StaticAll["group_buy_count_all"]); ?></td>
                                                    </tr>
													<?php if(is_array($request_list)): $i = 0; $__LIST__ = $request_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>even<?php else: ?>odd<?php endif; ?>">
															<td style="width: 120px"><?php echo (date('Y-m-d',$vo["time"])); ?></td>
										...
										<div class="grid-view">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <tr>
                                                        <td>统计总数</td>
                                                        <td><?php echo ($StaticAll["meal_hits_all"]); ?></td>
                                                        <td><?php echo ($StaticAll["meal_buy_count_all"]); ?></td>
                                                        <td>￥<?php echo ($StaticAll["meal_buy_money_all"]); ?></td>
                                                    </tr>
													<?php if(is_array($request_list)): $i = 0; $__LIST__ = $request_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>even<?php else: ?>odd<?php endif; ?>">
															<td style="width: 120px"><?php echo (date('Y-m-d',$vo["time"])); ?></td>
