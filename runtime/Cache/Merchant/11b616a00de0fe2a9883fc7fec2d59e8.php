...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<button class="btn btn-success" onclick="CreateShop()">发布内容</button>
					
					<button class="btn btn-success" onclick="ShowModule()">模板列表</button>
					 <!-- <span class="red">温馨提示：前端最多只显示10条</span> -->
...
function CreateModule(){
        window.location.href = "<?php echo U('Frontmanag/addmodule');?>";
    }
    function ShowModule(){
    	window.location.href = "<?php echo U('Frontmanag/detailmodulemanag');?>";
    }
