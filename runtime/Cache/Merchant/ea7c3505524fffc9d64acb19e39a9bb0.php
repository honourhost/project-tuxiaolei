...
<table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
	...
	<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>
		...
		<td class="norightborder">
			<?php if($c['sub'] == NULL): ?><a href="###" onclick="returnHomepage(<?php echo ($c["id"]); ?>,'<?php echo ($c["name"]); ?>')">选中</a>
			<?php else: ?>
				<a href="###" onclick="returnHomepage(<?php echo ($c["id"]); ?>,'<?php echo ($c["name"]); ?>')">选中</a> &nbsp; 
				<a href="?g=Merchant&c=Weixin&a=editClass&id=<?php echo ($c["id"]); ?>">详情</a><?php endif; ?>
		</td>
