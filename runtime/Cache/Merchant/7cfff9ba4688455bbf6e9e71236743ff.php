		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="form-group">
					...
					<div style="padding-top:4px;line-height:24px;"><a href="<?php echo ($config["site_url"]); ?>/index.php?g=Index&c=Recognition&a=see_qrcode&type=merchant&id=<?php echo ($now_merchant["mer_id"]); ?>&img=1" class="see_qrcode">查看二维码</a></div>
				</div>
				<div class="col-xs-12">
