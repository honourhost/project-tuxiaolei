		...
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					...
					<?php else: ?>
					<form enctype="multipart/form-data" class="form-horizontal" action="<?php echo U('weixin/create_account');?>" method="post" id="edit_form">
						<div class="tab-content">
							...
							<div id="basicinfo" class="tab-pane active">
								<input type="hidden" name="pigcms_id" value="<?php echo ($bind['pigcms_id']); ?>">
								<div class="form-group">
									<label class="col-sm-1"><label>微信初始url</label></label>
									<input name="url" value="<?php echo ($bind['qrcode_url']); ?>" type="hidden">
									<label>
                                    	<?php echo ($bind['qrcode_url']); ?>
                                    	<span><a>复制</a></span>
                                    </label>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>微信appid</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($bind['authorizer_appid']); ?>"  name="authorizer_appid" type="text"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>微信appsecret</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($bind['authorizer_refresh_token']); ?>"  name="authorizer_refresh_token" type="text"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>TOKEN</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($bind['func_info']); ?>"  name="func_info" type="text"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>EncodingAESKey</label></label>
									<input class="col-sm-2" size="20" value="<?php echo ($bind['user_name']); ?>"  name="wechat_encodingaeskey" type="text"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>微信类型</label></label>
									<input class="col-sm-2 col-sm-3" size="20" value="<?php echo ($bind['service_type_info']); ?>"  name="service_type_info" type="text"/>
									<br />(其中1为订阅号；2为服务号)
