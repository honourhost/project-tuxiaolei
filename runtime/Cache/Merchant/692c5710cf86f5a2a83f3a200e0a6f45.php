...
<!--		<h3>总营收(除去平台抽成)：<?php echo ($all_total_percent); ?></h3><h3>总已对账(即：可直接提现金额)<?php echo ($all_totalfinish_percent); ?></h3><a href="/store.php?g=Merchant&c=Count&a=getCash" class="btn btn-success">申请提现</a>-->
											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php if($order_list): if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
																...
																<td style="color:red;"><?php echo ($vo["balance_pay"]); ?></td>
