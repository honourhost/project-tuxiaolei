...
<div class="mright">
<?php if($m['sub']): ?><a href="<?php if (!$m['linkurl']){?>?g=Merchant&c=Link&a=<?php echo ($m["module"]); ?>&iskeyword=<?php echo intval($_GET['iskeyword']); }else{echo $m['linkurl'];}?>">详细</a><?php endif; ?>
