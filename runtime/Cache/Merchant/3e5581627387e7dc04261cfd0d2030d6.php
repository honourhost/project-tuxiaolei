            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="breadcrumbs-price">
						<span>
							<a href="<?php echo U('Jicai/getCash');?>" class="btn btn-success">立即提现</a>
						</span>
                        <h3>累计成功提现：<b><?php echo ($allGetCash); ?></b>元</h3>
                        <h3>可提现金额：<b><?php echo round($all_totalfinish_percent-$allGetCash,2);?></b>元</h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="grid-view">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php if($cash_list): if(is_array($cash_list)): $i = 0; $__LIST__ = $cash_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd">
                                                    <td><?php echo ($vo["id"]); ?></td>
                                                    <td><?php echo ($vo["cash_num"]); ?></td>
                                                    <td><?php echo date("Y-m-d H:i:s",$vo['create_time']); ?></td>
                                                    <td><?php if($vo['record_time']): echo date("Y-m-d H:i:s",$vo['record_time']); else: ?>还没有进行处理的申请<?php endif; ?></td>
                                                    <td><?php if($vo['record_status']==1): ?>提现成功<?php elseif($vo['record_status']==2): ?>提现被驳回<?php else: ?>正在申请中<?php endif; ?></td>
                                                    <td class="textcenter font12"><?php echo ($vo["note"]); ?></td>
                                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                            <?php else: ?>
                                            <tr class="odd"><td class="textcenter red" colspan="16" >该的店铺暂时还没有提现记录。</td></tr><?php endif; ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
