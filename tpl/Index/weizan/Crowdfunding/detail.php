...
<head>
    ...
    <title>{pigcms{$article.title} | 农丁众筹</title>
    <meta name="keywords" content="{pigcms{$config.seo_keywords}" />
    <meta name="description" content="{pigcms{$article.digest}" />
...
<div class="content-box" style="margin-top: 20px;">
    <div class="content-main">
        <div class="content-box-left" style=" border: 0;">
            <style>
                ...
                .bdsharebuttonbox a{
                    ...
                    margin-top: 10px;
                    margin-bottom: 10px;
                    background: url({pigcms{$static_path}images/atc1.jpg) no-repeat;
                }
                .bdsharebuttonbox a.weixin{
                    background-position: 0 0px;
                }
                .bdsharebuttonbox a.tsina{
                    background-position: 0 -60px;
                }
                .bdsharebuttonbox a.douban{
                    background-position: 0 -120px;
                }
                .bdsharebuttonbox a.renren{
                    background-position: 0 -180px;
                }
                .bdsharebuttonbox a.tqq{
                    background-position: 0 -240px;
                }
                .bdsharebuttonbox a.h163{
                    background-position: 0 -60px;
                }
            </style>
            <div class="con-top-mains">
                <div class="content-fenxiang">
                    <label>分享到</label>
                    <div id="bdshare" class="bdsharebuttonbox" data="{'url':'http://www.baidu.com'}">
                        <a href="#" class="weixin" data-cmd="weixin" title="分享到微信" data="{'url':'http://www.baidu.com'}"></a>
                        <a href="#" class="tsina" data-cmd="tsina" title="分享到新浪微博"></a>
                        <a href="#" class="douban" data-cmd="douban" title="分享到豆瓣网"></a>
                        <a href="#" class="renren" data-cmd="renren" title="分享到人人网"></a>
                        <a href="#" class="tqq" data-cmd="sqq" title="分享到腾讯微博"></a>
                    </div>
                    <script>
                        /*
                         * 动态设置百度分享URL的函数,具体参数
                        ...
                        function SetShareUrl(cmd, config) {
                            ...
                            config.bdUrl = "http://www.xiaonongding.com/wap.php?g=Wap&c=Crowdfunding&a=detail&crowdid={pigcms{$article.crowd_id}";
                ...
                <div class="content-con">
                    ...
                    <div class="content-tm">
                        <i class="inbg2 zhhf2"></i>&nbsp;来源：<b>{pigcms{$article.merchant.name}</b>
                        <i class="inbg3 zhhf2"></i>
                        <h3>发布时间：<php>echo date("Y-m-d H:m:s",$article['starttime']);</php></h3>
                        <i class="inbg4 zhhf2" style="margin-left: 40px;"></i>&nbsp;已完成金额：<?php echo $article["total"];?>元

                    </div>
                    <div class="page-contents">
                        <p>
                            <if condition="$article['video_url']">
                                <iframe  frameborder="0" width="320" height="240" style="position: relative; left: 50%; margin-left: -160px; margin-top: 15px; margin-bottom: 10px;" src="http://v.qq.com/iframe/player.html?vid={pigcms{$article['video_url']}&tiny=0&auto=0" allowfullscreen></iframe></if>
                            {pigcms{$article.content}
                        </p>
                        <div id="qrcode" style="text-align: center;"><p>扫码参与</p></div>
                ...
                <div class="mod_talk_edit mt30" style="width: 705px;">
                    ...
                    <div class="mod_talk_edit_cnt">
                        ...
                        <div id="textarea" class="qui-textArea" data-width="536" data-height="80" style="">
                            <textarea placeholder="发表评论" class="ui2_textarea" style="width: 673px; height: 100px;"></textarea>
                            <div class="tips">
        ...
        <div class="content-box-right" style="background: none; border: 0;">
            <!-- 农场主头像 -->
            <div class="nc-main">
                <div class="nc-logo"><img src="{pigcms{$article.merchant.person_image}"></div>
                <h3 class="titles">{pigcms{$article.merchant.name}</h3>
                <ul class="shop-wz">
                    <li>
                        <h3>众筹目标</h3>
                        <b>{pigcms{$article.funds}</b>
                        <span></span>
                    </li>
                    <li>
                        <h3>已筹金额</h3>
                        <b>{pigcms{$article.total}</b>
                    </li>
                </ul>
                <div style="clear: both;"></div>
            </div>
            <!-- TA的其他文章 -->
            <div class="wz-more ta-more" style="display: none;">
                <h4 class="side-title fontYaHei" style="font-size: 16px; margin-right: 10px; margin-left: 10px; padding-bottom: 11px; margin-bottom: 10px; border-bottom: 1px solid #d7d7d7;">TA的其他文章</h4>
                <p style="display: block; width: 100%; text-align: center; padding: 10px 0px;">作者很懒哦！还没有发布新闻</p>
            ...
            <div class="caini">
                <h4 class="side-title fontYaHei" style="font-size: 16px; margin-right: 10px; margin-left: 10px; padding-bottom: 11px; margin-bottom: 10px; border-bottom: 1px solid #d7d7d7;">热门关注</h4>
                <ul>
                    <volist name="textlist" id="onetext">
                        <li>
                            <div class="left-img">
                                <a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Crowdfunding&a=detail&crowdid={pigcms{$onetext.crowd_id}" style="cursor:pointer;"><img src="{pigcms{$onetext.webpic}"></a>
                            </div>
                            <div class="right-title">
                                <a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Crowdfunding&a=detail&crowdid={pigcms{$onetext.crowd_id}" style="cursor:pointer;">
                                    <h3>{pigcms{$onetext.title}</h3>
                                    <span><php>echo date("Y-m-d H:m:s",$onetext['starttime']);</php></span>
                                </a>
                            </div>
                            <div style="clear: both;"></div>
                        </li>
            ...
            <div class="lmSideCell bookzk" style="padding: 15px 0px; background: #fff; margin-top: 15px;">
                <h4 class="side-title fontYaHei" style="font-size: 16px; margin-right: 10px; margin-left: 13px; padding-bottom: 11px; margin-bottom: 10px; border-bottom: 1px solid #d7d7d7;">关注小农丁</h4>
                <div class="cell-cont">
...
<script language="javascript">
    ...
    if (is_mobile()) {
        document.location.href = 'http://www.xiaonongding.com/wap.php?g=Wap&c=Crowdfunding&a=detail&crowdid={pigcms{$article.crowd_id}';
    }
</script>
<script>
    $(document).ready(function () {
        var crowdid="{pigcms{$article.crowd_id}";
        $('#qrcode').qrcode({width: 164,height: 164,text: "http://www.xiaonongding.com/wap.php?g=Wap&c=Crowdfunding&a=detail&crowdid="+crowdid});
