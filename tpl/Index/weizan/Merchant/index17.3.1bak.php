...
*/
			...
			.productList .prdNav {
				...
				width: 100%;
				margin-bottom: 20px;
	            margin-left: calc(50% - 75px * {pigcms{$category_count+1});
			}
...
<div class="wrapper" id="fortop">
			...
			<div class='bannerBox an_mo floatPosition'>
				<div id="block" class="block clearfix">
					...
					<img src="{pigcms{$static_path}images/xnd_img/white.gif" width="1920" height="600" data-src="{pigcms{$static_path}images/xnd_img/banner1.jpg" class="fixedImage" alt="">
					<!-- <img src="{pigcms{$static_path}images/xnd_img/white.gif" width="1920" height="600" data-src="{pigcms{$static_path}images/xnd_img/banner2.jpg" class="fixedImage2" alt=""> -->
					<div class="videoBox_div">
						<div class="videoBox_left">
							<if condition="$currentmerchant['person_image']">
							<img class="videoBox_left_logo" src="{pigcms{$currentmerchant.person_image}" />
							<else/>
							<img class="videoBox_left_logo" src="{pigcms{$static_path}images/xnd_img/275x185.jpg" />
						    </if>
							<h3>
								<span><img src="{pigcms{$static_path}images/xnd_img/videoBox_left_icon01.png"></span>
								{pigcms{$currentmerchant.person_name}的农场
								<span><img src="{pigcms{$static_path}images/xnd_img/videoBox_left_icon02.png"></span>
							</h3>
							<p>
								<if condition="$currentmerchant['person_info']">
								<php>echo getStrSub($currentmerchant['person_info']);</php>
								<else/>
								{pigcms{$currentmerchant.person_name}同学很懒哦~~没有任何梦想！
							    </if>
							</p>
						</div>
						<div class="videoBox">
						<div class="videoContent">
							<php>$len=strlen($videos[0]['video_url']);if($len<25){</php>
							<iframe frameborder="0" src="http://v.qq.com/iframe/player.html?vid={pigcms{$videos[0].video_url}" allowfullscreen="" width="100%" height="100%" scrolling="no"></iframe>
							<php>}else{</php>
							...
							<div class="videoNav">
								<ul class="clearfix">
									<volist name="videos" id="video" key="k"> 
										<if condition="$k eq 1">
											<php>$len=strlen($video['video_url']);if($len<25){</php>
									<li data-video="http://v.qq.com/iframe/player.html?vid={pigcms{$video.video_url}" class="active">
											<php>}else{</php>
									<li data-video="{pigcms{$video.video_url}" class="active">
										...
										<else/>
										<php>$len=strlen($video['video_url']);if($len<25){</php>
									<li data-video="http://v.qq.com/iframe/player.html?vid={pigcms{$video.video_url}">
											<php>}else{</php>
					...
					<div class="recommendPRD container floatPosition floatPosition">
						...
						<div class="RCprdList">
							...
							<ins></ins>
							<div class="image">
								<a href="/group/{pigcms{$onegroup.group_id}.html" onclick="_gaq.push(['_trackEvent', '小农丁', '点击', '-头部区域-1-产品1-1']);" target="_blank">
									<img src="{pigcms{$onegroup[all_pic][0].image}" data-src="{pigcms{$onegroup[all_pic][0]}" width="577" height="432" alt="">
									</a>
							</div>
							<div class="content">
								<div class="zw-module-bigcard-iteminfo2">
									...
									<ul class="zw-module-bigcard-infolist">
										<li>
											...
											{pigcms{$onegroup.s_name}<br>
										</li>
										
										<li>
											<i class="zwui-iconfont icon-star-line"></i>
											已有<b>{pigcms{$currentmerchant.fans_count}</b>个粉丝关注该商品！
										</li>
									</ul>
								</div>
								<div class="price">
									<div class="old">
										￥<span>{pigcms{$onegroup.old_price}</span>
									</div>
									<em>￥</em>
			...
			<div class='productList an_mo '>
				<div id="block" class="block clearfix floatPosition">
					...
					<!--	<ul id="tags">
							...
							<li>
								<A onClick="selectTag('tagContent{pigcms{$k}',this)" href="javascript:void(0)">{pigcms{$category['sort_name']}</a>
							</li>
						    </volist>
						</ul>-->
					</div>
					...
					<DIV id="tagContent">
						<DIV class="tagContent selectTag" id="tagContent0">
							<if condition="$all_meals">
							<div class="clearfix" style="margin-right: -25px;">
								<volist name="allproduct" id="onemeal">
								<div class="prodcutionItem">
									<a href="/group/{pigcms{$onemeal.group_id}.html" target="_blank">
										<div class="image">
											<img width="318" height="198" src="{pigcms{$onemeal[all_pic][0].image}" alt="">
										</div>
										<div class="content">
											<h3>
												<span>
													{pigcms{$onemeal.name}<if condition="$onemeal.is_lottery_group_buy eq 1">【抽奖团】<elseif condition="$onemeal.is_lottery_group eq 1"/>【普通拼团】<else/>【普通特卖】</if>
												</span>
											</h3>
											<p class="price">
												<span>¥</span>
							...
							<div class="clearfix" style="margin-right: -25px;">
								<div style=" text-align: center; line-height: 50px; color: green">
									...
									{pigcms{$currentmerchant.person_name}同学很懒哦~~该分类没有发布任何商品！
						...
						<volist name="category_meals" id="meal" key="k">
							<if condition="$meal">
						<DIV class="tagContent" id="tagContent{pigcms{$k}">
							<div class="clearfix" style="margin-right: -25px;">
								<volist name="meal" id="onemeal">
								<div class="prodcutionItem">
									<a href="/meal/{pigcms{$merchantmstore.store_id}.html#sort_{pigcms{$onemeal.sort_id}" target="_blank">
										<div class="image">
				...
				<div class="zw-module-bigcard-wrap2 clearfix">
					<div class="zw-module-bigcard-item2 bigcard-black">
						<a href="/activity/{pigcms{$activity.pigcms_id}.html" target="_blank">
							<img class="zw-module-bigcard-itemimg" src="{pigcms{$activity.list_pic}" width="400" height="270" title="" alt="">
						</a>
						<if condition="$activity['is_finish']">
												<div class="bmbox">
						...
						<div class="zw-module-bigcard-iteminfo3 bigcard-iteminfo-noinfotype">
							...
							<div class="zw-module-bigcard-infonum2">
								共需<span>{pigcms{$activity.all_count}</span>人
							</div>
							<h2>
						      <a href="" title="" target="_blank">
						      	{pigcms{$activity.title}
						      </a>
					        </h2>
							<ul class="zw-module-bigcard-infolist2">
								<li>
									<i class="zwui-iconfont icon-star-line"></i>
									{pigcms{$activity.name}<br />
								</li>
							</ul>
							<div class="zw-module-bigcard-price">
								<span class="line">已有</span>
								<em>{pigcms{$activity.part_count}</em>人参加
							</div>
							<div class="zw-module-bigcard-bottombar2">
								<div class="zw-module-bigcard-datebar2">
									截止时间：<php> echo date("Y-m-d", time($activity['end_time']));</php> 
								</div>
								<a class="zw-module-bigcard-btn2" href="/activity/{pigcms{$activity.pigcms_id}.html" target="_blank">
									立即参加
								</a>
							</div>
						</div>
				...
				<else/>
						<p style="text-align:center;">目前该商家还没有发布活动</p>
			</if>
			...
			<div class="confession">
				...
				<div class="portrait_title">
					<h3>
						{pigcms{$currentmerchant.person_name}的农场梦
					</h3>
					...
					<p>
						...
						<if condition="$currentmerchant['person_info']">
					<span>"</span>{pigcms{$currentmerchant.person_info}<span>"</span>
					<else/>
					<p style=" text-align: center">{pigcms{$currentmerchant.person_name}同学很懒哦~~没有任何梦想！</p>
				    </if>
				...
				<div id="block" class="block clearfix">
					...
					<div class="container" style="padding-bottom: 50px;">
						<ul class="clearfix moreTopic">
							<li>
								<a href="http://www.xiaonongding.com/merindex/592.html"><img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/0101.jpg" width="248" height="344" alt=""></a>
							</li>
							<li>
								<a href="http://www.xiaonongding.com/merindex/583.html"><img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/0102.jpg" width="248" height="344" alt=""></a>
							</li>
							<li>
								<a href="http://www.xiaonongding.com/merindex/592.html"><img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/0103.jpg" width="248" height="344" alt=""></a>
							</li>
							<li>
								<a href="http://www.xiaonongding.com/merindex/592.html"><img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/0104.jpg" width="248" height="344" alt=""></a>
							</li>
						</ul>
					</div>
					<!-- txtModule txtMself end -->
						...
						<ul class="clearfix">
							...
							<li>
								<a>
									...
									<img src="{pigcms{:U('Index/Recognition/see_qrcode',array('type'=>'merchant','id'=>$currentmerchant['mer_id']))}" width="126" height="126" alt="">关注农场
								</a>
							</li>
							<li>
