...
<div class="wrapper" id="fortop">
			...
			<div id='block_251570' class='productList an_mo'>
				<div id="block" class="block clearfix">
					...
					<div class="prdNav">
						<ul id="tags">
							<li class="cur">
								<A onClick="selectTag('tagContent0',this)" href="javascript:void(0)">分类名</a>
							</li>
							<li>
								<A onClick="selectTag('tagContent1',this)" href="javascript:void(0)">分类名</a>
							</li>
							<li>
								<A onClick="selectTag('tagContent2',this)" href="javascript:void(0)">分类名</a>
							</li>
							<li>
								<A onClick="selectTag('tagContent3',this)" href="javascript:void(0)">分类名</a>
							</li>
							<li>
								<A onClick="selectTag('tagContent4',this)" href="javascript:void(0)">分类名</a>
							</li>
						</ul>
					</div>
					<!-- txtModule txtMself end -->
								...
								<div class="prodcutionItem">
									<a href="" target="_blank">
										...
										<div class="content">
											<h3>
												<span>
													1【途牛定制小团】毛里求斯7晚9日半自助游深圳往返，全程中文服务，私人订制精品包团
												</span>
											</h3>
											<p class="price">
												<span>¥</span>
								...
								<div class="prodcutionItem">
									<a href="" target="_blank">
										...
										<div class="content">
											<h3>
												<span>
													【途牛】毛里求斯7晚9日半自助游深圳往返，全程中文服务，私人订制精品包团
												</span>
											</h3>
											<p class="price">
												<span>¥</span>
								...
								<div class="prodcutionItem">
									<a href="" target="_blank">
										...
										<div class="content">
											<h3>
												<span>
													【定制小团】毛里求斯7晚9日半自助游深圳往返，全程中文服务，私人订制精品包团
												</span>
											</h3>
											<p class="price">
												<span>¥</span>
								...
								<div class="prodcutionItem">
									<a href="" target="_blank">
										...
										<div class="content">
											<h3>
												<span>
													【小团】毛里求斯7晚9日半自助游深圳往返，全程中文服务，私人订制精品包团
												</span>
											</h3>
											<p class="price">
												<span>¥</span>
			...
			<div class="confession">
				...
				<div class="portrait_title">
					...
					<p>
						"阿斯顿法师打发士大夫东方阿斯顿法师打发士大夫东方阿斯顿法师打发士大夫东方阿斯顿法师打发士大夫东方阿斯顿法师打发士大夫东方阿斯顿法师打发士大夫东方"
					</p>
				</div>
			</div>
