...
<div class="wrapper" id="fortop">
			...
			<div id='block_251569' class='bannerBox an_mo'>
				<div id="block" class="block clearfix">
					...
					<div class="videoBox">
						<div class="videoContent">
							<iframe frameborder="0" src="http://v.qq.com/iframe/player.html?vid=s0161z4qrz4&tiny=0&auto=0&width=616&height=379" allowfullscreen="" width="100%" height="100%" scrolling="no"></iframe>
						</div>
						<div class="videoList">
							...
							<div class="videoNav">
								<ul class="clearfix">
									<li data-video="http://v.qq.com/iframe/player.html?vid=s0161z4qrz4&tiny=0&auto=0&width=616&height=379" class="active">
										<h3>预告片</h3>
										<p style='font-size:12px; color:#b8b8b8;'>天堂原乡</p>
									</li>
									...
									<li data-video="http://v.qq.com/iframe/player.html?vid=e0162w20peo&tiny=0&auto=0&width=616&height=379">
										<!--<ins class="new"></ins>-->
										<h3>第二集</h3>
										<p style='font-size:12px; color:#b8b8b8;'>召唤海豚</p>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="recommendPRD container floatPosition">
						...
						<div class="RCprdList">
							...
							<ins></ins>
							<div class="image">
								<a href="" onclick="_gaq.push(['_trackEvent', '老于推荐毛里求斯PC-成都', '点击', '-头部区域-1-产品1-1']);" target="_blank">
									<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/sh-lyq.jpg" width="577" height="441" alt="">
										
									</a>
							</div>
							<div class="content">
								<div class="prdFlash">
									<span class="title">亮点1</span>
									上海直飞往返，提供中文服务，免费WIFI
								</div>
								<div class="prdFlash">
									<span class="title">亮点2</span>
									酒店套房和别墅带私家泳池,拥有毛球最美丽的海滩景致
								</div>
								<div class="prdFlash">
									<span class="title">亮点3</span>
									娇韵诗旗下水疗中心，丰富的免费陆上/水上运动项目
								</div>
								<div class="prdFlash cur">
									<span class="title">亮点4</span>
									工行伴您游全球活动，预定指定产品优惠1000元/成人(名额有限先到先得) 
								</div>
								<div class="price">
									<div class="old">
										￥<span>11861</span>
			...
			<div id='block_251570' class='productList an_mo' liWithHan='cms_251570_产品列表'>
				<div id="block" class="block clearfix">
					<!-- txtModule txtMself start -->
					...
					<div class="clearfix" style="margin-right: -25px;">
						<div class="prodcutionItem">
							<a href="" target="_blank">
								<div class="image">
									<img width="318" height="198" src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img02.jpg" alt="">
								</div>
								<div class="content">
									<h3>
										<span>
											【途牛定制小团】毛里求斯7晚9日半自助游深圳往返，全程中文服务，私人订制精品包团
										</span>
									</h3>
									<p class="price">
										<span>¥</span>
										<span class="sale_price">18186</span>
										<span>起</span>
										<span class="old_price" style="display:none;">18186</span>
									</p>
			...
			<div class='section1 floatPosition an_mo'>
				<div id="block" class="block clearfix">
					...
					<div style="height:226px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/tit1.png" height="226" />
					</div>
					<div style="height:275px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img1.jpg" height="275" />
					</div>
					<div style="height:630px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img2.jpg" height="630" />
					</div>
					<div style="height:275px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img3.jpg" height="275" />
					</div>
					<div style="height:630px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img4.jpg" height="630" />
					</div>
					<div style="height:275px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img5.jpg" height="275" />
					</div>
					<div style="height:630px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img6.jpg" height="630" />
					</div>
					<div style="height:275px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img7.jpg" height="275" />
					</div>
					<div style="height:630px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img8.jpg" height="630" />
					</div>
					<div style="height:274px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img9.jpg" height="274" />
					</div>
					<div style="height:630px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img10.jpg" height="630" />
					</div>
					<div style="height:274px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img11.jpg" height="274" />
					</div>
					<div style="height:629px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img12.jpg" height="629" />
					</div>
					<div style="height:271px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img13.jpg" height="271" />
					</div>
					<div style="height:632px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img14.jpg" height="632" />
					</div>
					<div style="height:274px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img15.jpg" height="274" />
					</div>
					<div style="height:630px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img16.jpg" height="630" />
					</div>
					<div style="height:274px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img17.jpg" height="274" />
					</div>
					<div style="height:628px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/img18.jpg" height="628" />
					</div>
					<!-- txtModule txtMself end -->
				</div>
			</div>
			...
			<div class='section2 floatPosition an_mo'>
				<div id="block" class="block clearfix">
					...
					<div style="height:573px;">
						<img src="{pigcms{$static_path}images/xnd_img/white.gif" data-src="{pigcms{$static_path}images/xnd_img/tiyanshi.jpg" height="573" alt="">
					</div>
					<!-- txtModule txtMself end -->
				</div>
			</div>
			...
			<div id='block_251578' class='copyrightbox an_mo'>
				<div id="block" class="block clearfix">
					...
					<div class="fixedPosition">
						<ul class="clearfix">
							<li><a href="javascript:void(0);"><span class="star"></span>推荐之星</a></li>
							<li><a href="javascript:void(0);"><span class="cont1"></span>浪漫毛里求斯</a></li>
							<li><a href="javascript:void(0);"><span class="cont2"></span>推荐酒店</a></li>
							<li><a href="javascript:void(0);"><span class="cont3"></span>街头美食风</a></li>
							<li><a href="javascript:void(0);"><span class="nav-tiyanshi"></span>本期体验师</a></li>
							<li><a href="javascript:void(0);"><span class="nav-tips"></span>旅行贴士</a></li>
							<li class="li_07">
								<a href="">
									<span class="laoyutuijian"></span>返回老于推荐
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<span class="code"></span>
									<img src="http://img.tuniucdn.com/site/file/zt/laoyutuijian/dibai/images/code.png" width="126" height="119" alt="">开启旅行二维码
								</a>
							</li>
							<li><a href="javascript:void(0);"><span class="returntop"></span>返回顶部</a></li>
						</ul>
					</div>
					<!-- txtModule txtMself end -->
					<!-- txtModule txtMself start -->
