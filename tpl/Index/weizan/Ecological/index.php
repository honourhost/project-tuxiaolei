		...
		<div class="main-fenlei">
			...
			<div class="fenlei-main">
				<div class="fenlei-left">
					...
					<div class="left-list">
						<volist name="vo.childfenlei" id="vo4" key="index3">
                             <if condition="$index3 eq 1">
								 <ul class="listleft">
									 <volist name="vo4.topfile" id="topfile2">
										 <li>
											 <a href="http://www.xiaonongding.com/group/{pigcms{$topfile2.group_id}.html">
												 <span><i></i><?php echo $topfile2['sale_count']+$topfile2['virtual_num'];?></span>
												 <h3>{pigcms{$topfile2.s_name}</h3>
											 </a>
										 </li>
									 </volist>
								 ...
								 <ul  style="display: none;" class="listleft">
									 <volist name="vo4.topfile" id="topfile2">
										 <li>
											 <a href="http://www.xiaonongding.com/group/{pigcms{$topfile2.group_id}.html">
												 <span><i></i><?php echo $topfile2['sale_count']+$topfile2['virtual_num'];?></span>
...
<script>
	$(".ul-tag li").mouseenter(function () {
		...
		$(this).parents(".fenlei-title").siblings(".fenlei-main").find(".listleft").hide().eq(t).show();
	});
</script>
</body>
</html>