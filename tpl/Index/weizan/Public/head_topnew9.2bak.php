...
<div class="q-layer-header">
		...
		<div class="zw-home-header">
			<div class="zw-home-header-wrap">
				<div class="zw-home-header-logo">
					<a href="/">
						<img src="{pigcms{$static_path}images/xnd_img/index_logo.png" alt="小农丁，F2F，F2F生态农场平台，创意采摘，农业众筹，农场活动，休闲观光，度假村，温泉农庄，科普基地，拓展培训，生态农庄" align="">
					</a>
				</div>
		...
		<div class="zw-home-nav">
			<ul class="zw-home-nav-wrap">
				...
				<li class="zw-home-nav-item">
					<a href="/jinrong/nongxiaodai/jinrong.html">小农贷</a>
				</li>
				<li class="zw-home-nav-item">
