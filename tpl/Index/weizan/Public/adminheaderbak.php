            ...
            <div class="navbar-custom-menu" style="float: left;margin-left: 10px;">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu" >
                        <div class="count" style=" margin-right: 10px; text-align: center;color: #fff; position: relative;max-height: 100px;padding: 15px 15px;">当前订单：<span id="number"></span></div>
                    </li>
                </ul>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{pigcms{:U('Chart/salestatis')}">
                        <i class="fa fa-user"></i> <span>销售统计</span>
                    </a>
                </li>
