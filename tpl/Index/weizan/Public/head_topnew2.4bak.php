...
<div class="q-layer-header">
			<div class="header-inner">
				<a href="/">
					<img class="index_logo" alt="小农丁" src="{pigcms{$static_path}images/xnd_img/index_logo_small.png"  height="18" />
				</a>
				<div class="index_nav">
					<ul class="nav-ul">
		...
		<div class="zw-home-header">
			<div class="zw-home-header-wrap">
				<div class="zw-home-header-logo">
					<a href="/">
						<img src="{pigcms{$static_path}images/xnd_img/index_logo.png" alt="小农丁" align="">
					</a>
				</div>
