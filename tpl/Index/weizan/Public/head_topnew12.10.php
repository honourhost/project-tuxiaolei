...
<div class="q-layer-header">
			<div class="header-inner">
				<a href="">
					<img class="index_logo" src="{pigcms{$static_path}images/xnd_img/index_logo_small.png"  height="18" />
				</a>
				<div class="index_nav">
					<ul class="nav-ul">
								...
								<div class="q-layer q-layer-nav q-layer-arrow">
									<ul>
										<li class="nav-list-layer">
											<a href="" title="">
												<i class="iconfont icon-luntan"></i> 小农丁论坛
												<i class="iconfont icon-jiantouyou"></i>
											</a>
											<div class="q-layer q-layer-section">
												<div class="q-layer">
													<div class="section-title">
														<a class="more" href="">全部版块
														<i class="iconfont icon-jiantouyou"></i>
													</a>
														<span>热门版块</span>
													</div>
		...
		<div class="zw-home-header">
			<div class="zw-home-header-wrap">
				<div class="zw-home-header-logo">
					<a href="index.html">
						<img src="{pigcms{$static_path}images/xnd_img/index_logo.png" align="">
					</a>
				</div>
				<div class="zw-home-header-search" id="zwhomeSearchs">
					<input type="text" name="kw" placeholder="搜索国家、城市、产品" autocomplete="off" class="zw-home-header-search-text" id="zwhomeSearchText">
		...
		<div class="zw-home-nav">
			<ul class="zw-home-nav-wrap">
				...
				<li class="zw-home-nav-item">
					<a href="sales.html">今日特卖</a>
				</li>
				<li class="zw-home-nav-item">
					<a href="cruise.html">农场活动</a>
				</li>
				<li class="zw-home-nav-item">
					<a href="">热门农场</a>
				</li>
				<li class="zw-home-nav-item">
					<a href="citywalk.html">即将上线</a>
				</li>
				<li class="zw-home-nav-item">
					<a href="show.html">特色馆</a>
				</li>
