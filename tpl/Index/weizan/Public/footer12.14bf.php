			...
			<div class="zw-footer-wrap">
							...
							<div class="layer">
								<div class="box">
									<form action="" method="get" target="_blank">
										<input type="text" name="email" value="" placeholder="请输入Email" class="iptext">
										<input type="submit" value="订阅" class="iptsbm">
									</form>
								</div>
							</div>
						</dd>
				...
				<div class="zw-footer-line2">
					<div class="zw-footer-listlinks">
						2004-2015 © 小农丁™ xiaonongding.com All rights reserved. 京ICP证140673号
					</div>
					<p class="zw-footer-frilinks">
						友情链接：
						<a href="" target="_blank">旅游地图</a>
						<a href="" target="_blank">公交查询</a>
						<a href="" target="_blank">火车时刻表查询</a>
						<a href="" target="_blank">天气预报查询15天</a>
					</p>
				</div>
			</div>
		</div>
