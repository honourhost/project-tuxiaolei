            ...
            <div class="navbar-custom-menu" style="float: left;margin-left: 10px;">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu" >
                        <div class="count" style="text-align: center;color: #91C7AE; position: relative; top: -20px; max-height: 100px;padding: 40px 15px; font-size: 22px;">当前订单：<span id="number"></span></div>
                    </li>
