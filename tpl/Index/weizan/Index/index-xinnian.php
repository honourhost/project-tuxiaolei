					...
					<div class="slider slider-hottravels">
						...
						<div class="slider-inner">
							<div class="item" style="display: block;">
								<ul>
									<if condition="$farmlist">
										<volist name="farmlist" id="farm">
										<li>
										<div class="travel">
											<a href="{pigcms{$config.site_url}/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
											<div class="photo" style="background-image:url({pigcms{$farm.merchant_theme_image});">
												<div class="like">
											...
											<div class="inner">
												...
												<a href="" target="_blank">
													<div class="caption">
														<h3>{pigcms{$farm.name}<span>农场主：{pigcms{$farm.person_name}</span></h3>
														<p>{pigcms{$farm.txt_info}</p>
													</div>
												</a>
											</div>
										</div>
				...
				<div class="zw-home-zhuanti-content">
					...
					<volist name="activity_lists" id="activities" key="k">
						...
						<li class="zw-home-zhuanti-one">
							<a href="/group/{pigcms{$activities.group_id}.html" target="_blank" >
								<p class="pics">
									<img class="lazy" data-original="{pigcms{$activities.list_pic}" src="{pigcms{$activities.list_pic}" width="570" height="auto" style="position:relative; top:-56px;">
								</p>
								<div class="mask"></div>
								<h3 class="title"> {pigcms{$activities.merchant_name}</h3>
								<p class="price"><em>{pigcms{$activities.money}</em>元起</p>
							</a>
						</li>
						...
						<li class="zw-home-zhuanti-item">
							<a href="/group/{pigcms{$activities.group_id}.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="{pigcms{$activities.list_pic}" src="{pigcms{$activities.list_pic}" width="275" height="auto" style="position:relative; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title"> {pigcms{$activities.merchant_name}</h3>
									<p class="price"><em>{pigcms{$activities.money}</em>元起</p>
				...
				<div class="zw-home-ziyouxing-content">
					<ul class="zw-home-ziyouxing-list clearfix">
						<li class="zw-home-ziyouxing-one">
							<a href="http://www.xiaonongding.com/article/305.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/huodong01.jpg" src="{pigcms{$static_path}images/xnd_img/placehold.png" width="570" height="267" style="position:relative; top:0px;">
									</p>
								<div class="infos">
								...
								<div class="titles">
									<h3 class="title">二舅和他的岭山柞耳</h3>
									<p class="time" style="display: none;">活动时间：2016年国庆10月1日——10月7日</p>
								</div>
							</a>
						</li>
						<li class="zw-home-ziyouxing-item">
							<a href="http://www.xiaonongding.com/article/304.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/huodong02.jpg" src="{pigcms{$static_path}images/xnd_img/placehold.png" width="275" height="183">
								</p>
								<div class="infos">
								...
								<div class="titles">
									<h3 class="title">传承匠心滋养之道——古法红糖</h3>
								</div>
							</a>
						</li>
						<li class="zw-home-ziyouxing-item">
							<a href="http://www.xiaonongding.com/article/306.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/huodong03.jpg" src="{pigcms{$static_path}images/xnd_img/placehold.png" width="275" height="183">
								</p>
								<div class="infos">
								...
								<div class="titles">
									<h3 class="title">寒地黑土——红谷小米</h3>
								</div>
							</a>
						</li>
						<li class="zw-home-ziyouxing-item">
							<a href="http://www.xiaonongding.com/article/308.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/huodong04.jpg" src="{pigcms{$static_path}images/xnd_img/placehold.png" width="275" height="183">
								</p>
								<div class="infos">
								...
								<div class="titles">
									<h3 class="title">像寻找初恋一样，寻找素颜水果——增城荔枝</h3>
								</div>
							</a>
						</li>
						<li class="zw-home-ziyouxing-item">
							<a href="http://www.xiaonongding.com/article/303.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/huodong05.jpg" src="{pigcms{$static_path}images/xnd_img/placehold.png" width="275" height="183">
								</p>
								<div class="infos">
								...
								<div class="titles">
									<h3 class="title">非遗剪纸——丁酉新年摆这个</h3>
								</div>
							</a>
						</li>
						<li class="zw-home-ziyouxing-item">
							<a href="http://www.xiaonongding.com/article/302.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/huodong06.jpg" src="{pigcms{$static_path}images/xnd_img/placehold.png" width="275" height="183">
								</p>
								<div class="infos">
								...
								<div class="titles">
									<h3 class="title">一杯茶一世人——品武夷韵味</h3>
								</div>
							</a>
						</li>
