...
<!-- 首屏 -->
		<div class="zw-home-firstfocus">
			...
			<div class="zw-home-sliders" id="homeSliders">
				<ul class="zw-home-sliders-list">
					...
					<li style="background-image:url({pigcms{$static_path}images/xnd_img/hd_01.jpg)">
						<a href="/merindex/596.html" target="_blank"></a>
					</li>
					<li style="background-image:url({pigcms{$static_path}images/xnd_img/hd_02.jpg)">
						<a href="/farm/index.html" target="_blank"></a>
					</li>
					<li style="background-image:url({pigcms{$static_path}images/xnd_img/hd_03.jpg)">
						<a href="/farm/index.html" target="_blank"></a>
					</li>
					<li style="background-image:url({pigcms{$static_path}images/xnd_img/hd_00.jpg)">
						<a href="/topic/gansu/index.html" target="_blank"></a>
					</li>
				...
				<ul class="zw-home-category-list" id="zwCategoryList">
					...
					<li class="zw-home-category-item">
						<p class="zw-home-category-icon">
							<span class="zwui-iconfont iconfont">&#xe6f9;</span>
						</p>
					...
					<li class="zw-home-category-item">
						<p class="zw-home-category-icon">
							<span class="zwui-iconfont iconfont" style="font-size: 30px; font-weight: bold; position: relative; left: -5px;">&#xe610;</span>
						</p>
						<h2 class="zw-home-category-title">{pigcms{$vo.cat_name}</h2>
						<p class="zw-home-category-subtitle">
							<if condition="$vo['cat_count'] gt 1">
					...
					<li class="zw-home-category-item">
						<p class="zw-home-category-icon">
							<span class="zwui-iconfont iconfont" style="font-size: 24px; position: relative; left: -5px;">&#xe641;</span>
						</p>
						<h2 class="zw-home-category-title">{pigcms{$vo.cat_name}</h2>
						<p class="zw-home-category-subtitle">
							<if condition="$vo['cat_count'] gt 1">
					...
					<li class="zw-home-category-item">
						<p class="zw-home-category-icon">
							<span class="zwui-iconfont iconfont" style="font-weight: bold;">&#xe60c;</span>
						</p>
						<h2 class="zw-home-category-title">{pigcms{$vo.cat_name}</h2>
						<p class="zw-home-category-subtitle">
							<if condition="$vo['cat_count'] gt 1">
					...
					<li class="zw-home-category-item">
						<p class="zw-home-category-icon">
							<span class="zwui-iconfont iconfont" style="font-size: 24px; position: relative; left: -3px;">&#xf0062;</span>
						</p>
						<h2 class="zw-home-category-title">{pigcms{$vo.cat_name}</h2>
						<p class="zw-home-category-subtitle">
							<if condition="$vo['cat_count'] gt 1">
			...
			<div class="zw-home-todaysale-wrap">
				...
				<div class="zw-home-todaysale-content" id="tdsaleContent">
								...
								<div class="buytoday-cont">
									<a href="/group/{pigcms{$index_tui_group_list[$i].group_id}.html" target="_blank">
										<div class="buytoday-photo">
											<img src="{pigcms{$index_tui_group_list[$i].list_pic}">
											<div class="cont">
												<p>{pigcms{$index_tui_group_list[$i].s_name}</p>
											</div>
										</div>
									</a>
									<div class="buytoday-price">
										...
										<span class="price"><em>{pigcms{$index_tui_group_list[$i].price}</em>元起</span>
									</div>
								</div>
								<div class="buytoday-ft">
									<span class="text">
										<a href="" target="_blank">{pigcms{$index_tui_group_list[$i].name}</a>
									</span>
								</div>
							</div>
						</li>
					...
					<ul class="zw-home-todaysale-list clearfix" style="display:none;">
						...
						<if condition="$index_tui_group_list[4]">
					<ul class="zw-home-todaysale-list clearfix" style="display:none;">
						<for start="6" end="9">
						<if condition="$index_tui_group_list[$i]">
						<li class="zw-home-todaysale-item">
		...
		<div class="zw-home-ziyouxing">
			<div class="zw-home-ziyouxing-wrap">
				<div class="zw-home-titlerow clearfix">
					<h2 class="zw-home-bigtitle fontYaHei">一起玩众筹</h2>
		...
		<div class="zw-home-wanle">
			<div class="zw-home-wanle-wrap">
				<div class="zw-home-titlerow clearfix">
					<h2 class="zw-home-bigtitle fontYaHei">热荐农场</h2>
					<p class="zw-home-subtitle">在诗情画意的田间农场里设宴畅聊，栽种赏玩，怡然自得！</p>
					<ul class="zw-home-tags"> 
						<li class="active"><a href="" target="_blank">主题农庄</a></li>
						<li><a href="" target="_blank">特色生态游</a></li>
						<li><a href="" target="_blank">特色农家乐</a></li>
					</ul>
				</div>
				<div class="zw-home-wanle-content">
					<ul class="zw-home-wanle-list clearfix">
						<li class="zw-home-wanle-one">
							<a href="./merindex/599.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/merchant/000/000/599/567c1caf12d7a.jpg" src="http://www.xiaonongding.com/upload/merchant/000/000/599/567c1caf12d7a.jpg" width="auto" height="265" style="position:relative; left:-14px;">
								</p>
								<div class="mask"></div>
								<h3 class="title">陇萃堂兰州特产专供</h3>
								<div class="infos clearfix">
									<p class="type">【陇萃堂】2014年被纳入甘肃省政府重点...</p>
									<p class="price"><em>兰州</em></p>
								</div>
							</a>
						</li>
						<li class="zw-home-wanle-item">
							<a href="./merindex/593.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-01.jpg" src="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-01.jpg" width="120" height="120">
								</p>
								<h3 class="title">宁夏塞外名羊-盐池滩羊</h3>
								<p class="ico">宁夏回族自治区，地处我国西部黄河上游地区</p>
								<em class="price">宁夏</em>
							</a>
						</li>
						<li class="zw-home-wanle-item">
							<a href="./merindex/583.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-02.jpg" src="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-02.jpg" width="120" height="120">
								</p>
								<h3 class="title">信军农场</h3>
								<p class="ico">张信军是定西县一中的一名教师，在他代的班级...</p>
								<p class="price"><em>定西</em></p>
							</a>
						</li>
						<li class="zw-home-channel-more zw-home-wanle-more">
							<div class="titles">
								<a href="" target="_blank" >
									<p class="title">查看更多<br>热荐农场</p>
									<p class="arrow">
										<span class="zwui-iconfont icon-more"></span>
									</p>
								</a>
							...
							<p class="list">
								<a href="./merindex/599.html" target="_blank">陇萃堂</a>&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="./merindex/594.html" target="_blank" >颐寿园</a>&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="./merindex/596.html" target="_blank" >老磨坊</a>
								
							</p>
						</li>
						<li class="zw-home-wanle-item">
							<a href="./merindex/598.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-03.jpg" src="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-03.jpg" width="120" height="120">
								</p>
								<h3 class="title">增盛兴天水老字号特产专卖</h3>
								<p class="ico">增盛兴生在天水长在天水并深深的爱着天水...</p>
								<p class="price"><em>天水</em></p>
							</a>
						</li>
						<li class="zw-home-wanle-item">
							<a href="./merindex/596.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-04.jpg" src="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-04.jpg" width="120" height="120">
								</p>
								<h3 class="title">马师傅老磨坊</h3>
								<p class="ico">马师傅的小磨坊位于甘肃的一个小村庄，这里的人们和睦友善...</p>
								<p class="price"><em>天水</em></p>
							</a>
						</li>
						<li class="zw-home-wanle-item">
							<a href="./merindex/601.html" target="_blank" >
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-05.jpg" src="http://www.xiaonongding.com/tpl/Static/weizan/images/xnd_img/pics-05.jpg" width="120" height="120">
								</p>
								<h3 class="title">敦煌莫园</h3>
								<p class="ico">小农丁宁夏专题注入得到当地政府的大力支持，组建一马莹为首的团队...</p>
								<p class="price"><em>敦煌</em></p>
							</a>
						</li>
					</ul>
		...
		<div class="zw-home-zhuanti">
			<div class="zw-home-zhuanti-wrap">
				<div class="zw-home-titlerow clearfix">
					...
					<p class="zw-home-subtitle">组织朋友回归自然，体验乡村，到农场体验线下亲子教育</p>
					<ul class="zw-home-tags"> 
						<volist name="activity_type_list" id="type" key="k">
							<if condition="$k==1">
								<li class="active"><a href="" target="_blank">{pigcms{$type['type_name']}</a></li>
								<else/>
								<li><a href="" target="_blank">{pigcms{$type['type_name']}</a></li>
							</if>
						</volist>
					</ul>
				</div>
				<div class="zw-home-zhuanti-content">
					<ul class="zw-home-zhuanti-list clearfix">
						<li class="zw-home-zhuanti-one">
							<a href="./merindex/583.html" target="_blank" >
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/merchant/000/000/583/567b64c3ace43.jpg" src="http://www.xiaonongding.com/upload/merchant/000/000/583/567b64c3ace43.jpg" width="570" height="295" style="position:relative; top:-56px;">
								</p>
								<div class="mask"></div>
								<div class="mask2"></div>
								
								<h3 class="title">张信军是定西县一中的一名教师，在他代的班级里每年送进全国一...</h3>
								<p class="price"><em>定西</em></p>
							</a>
						</li>
						<li class="zw-home-zhuanti-item">
							<a href="./activity/18.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/extension/000/000/593/s_567d8c9fa8617.jpg" src="http://www.xiaonongding.com/upload/extension/000/000/593/s_567d8c9fa8617.jpg" width="275" height="185" style="position:relative; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title">这里边吃美味烧烤边欣赏美丽的花</h3>
									<p class="price"><em>天水</em></p>
								</div>
							</a>
						</li>
						<li class="zw-home-zhuanti-item">
							<a href="./activity/17.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/extension/000/000/592/s_567d89e3d645c.jpg" src="http://www.xiaonongding.com/upload/extension/000/000/592/s_567d89e3d645c.jpg" width="275" height="185" style="position:relative; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title">夹河农场“种菜务农+自助烧烤会”体验游，可以...</h3>
									<p class="price"><em>陇南</em></p>
								</div>
							</a>
						</li>
						<li class="zw-home-zhuanti-item">
							<a href="./activity/16.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/extension/000/000/594/s_567d87d788a37.jpg" src="http://www.xiaonongding.com/upload/extension/000/000/594/s_567d87d788a37.jpg" width="275" height="185" style="position:relative; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title">有朋友过来觉得这里太适合玩真人cs了，想玩一把...</h3>
									<p class="price"><em>临夏</em></p>
								</div>
							</a>
						</li>
						<li class="zw-home-zhuanti-item">
							<a href="./activity/15.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/extension/000/000/592/s_567d850fe2cc8.jpg" src="http://www.xiaonongding.com/upload/extension/000/000/592/s_567d850fe2cc8.jpg" width="275" height="185" style="position:relative; border: 1px solid #000000; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title">爵士庄园亲子采摘，亲子游活动每周一次，包括午餐...</h3>
									<p class="price"><em>平凉</em></p>
								</div>
							</a>
						</li>
						
						<li class="zw-home-zhuanti-item">
							<a href="./merindex/592.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/merchant/000/000/592/567497961418a.jpg" src="http://www.xiaonongding.com/upload/merchant/000/000/592/567497961418a.jpg" width="275" height="185" style="position:relative; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title">我想做一个和蘑菇公寓的一样的有地图的网站，我们...</h3>
									<p class="price"><em>天水</em></p>
								</div>
							</a>
						</li>
						<li class="zw-home-channel-more zw-home-zhuanti-more">
							<div class="titles">
								<a href="" target="_blank">
									<p class="title">查看更多<br>主题推荐产品</p>
									<p class="arrow">
										<span class="zwui-iconfont icon-more"></span>
									</p>
								</a>
					...
					<ul class="zw-home-zhuanti-list clearfix" style="display: none;">
						<li class="zw-home-zhuanti-one">
							<a href="./merindex/583.html" target="_blank" >
								<p class="pics">
									<img class="lazy" data-original="http://www.xiaonongding.com/upload/merchant/000/000/583/567b64c3ace43.jpg" src="http://www.xiaonongding.com/upload/merchant/000/000/583/567b64c3ace43.jpg" width="570" height="295" style="position:relative; top:-56px;">
