...
<body id="login" class="theme--www" style="position: static;">
	<header id="site-mast" class="site-mast site-mast--mini">
	    <div class="site-mast__branding cf">
			<a href="{pigcms{$config.site_url}"><img src="{pigcms{$static_path}images/xnd_img/header_logo.gif" alt="{pigcms{$config.site_name}" title="{pigcms{$config.site_name}" style="height:34px;"/></a>
	    </div>
	</header>
