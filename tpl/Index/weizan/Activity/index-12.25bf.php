		...
		<div class="zw-module-banner-wrap">
			...
			<ul class="zw-module-banner-imglist clearfix">
				<li class="banner-img-cell">
					<a class="banner-img-cell-link" href="" target="_blank" style="background-image:url({pigcms{$static_path}images/xnd_img/activity-banner01.jpg);"></a>
				</li>
				<li class="banner-img-cell">
					<a class="banner-img-cell-link" href="" target="_blank" style="background-image:url({pigcms{$static_path}images/xnd_img/activity-banner02.jpg);"></a>
				</li>
			</ul>
						...
						<li>
							<div class="unit-list-left">
								<div class="unit-list-title">
								  <a href="#">
									<h3>盛世新河盐池滩羊</h3>
									<p>色蛋糕史蒂芬色蛋糕史蒂芬港的风格史蒂芬港但是风格色蛋糕史蒂芬港的风格史蒂芬港但是风格港的风格史蒂芬港但是风格色蛋糕史蒂芬港的风格史蒂芬港但是风格</p>
								  </a>
								</div>
								<div class="unit-list-btm">
									...
									<div class="unit-list-btm-center">
										<h3>有效期：至2015-1-23<span>0人已报名</span></h3>
										<p>农场：<span>小王家的农场</span></p>
										<p>地址：山东省青岛市崂山区</p>
									</div>
							...
							<div class="unit-list-right">
								<a href="#"><img src="{pigcms{$static_path}images/xnd_img/275x185.jpg" /></a>
							</div>
