						...
						<div class="zw-module-bigcard-wrap clearfix">
							<div class="zw-module-bigcard-item bigcard-black" style="border: 1px solid #d9d9d9;">
								<a href="" target="_blank">
									<img class="zw-module-bigcard-itemimg" src="{pigcms{$static_path}images/xnd_img/275x185.jpg" data-original="{pigcms{$static_path}images/xnd_img/275x185.jpg" width="360" height="270" title="" alt="蔓莎女子会舍">
								</a>
								<div class="zw-module-bigcard-iteminfo bigcard-iteminfo-noinfotype">
									...
									<ul class="zw-module-bigcard-infolist">
										...
										<li>
											<i class="zwui-iconfont icon-star-line"></i> 微信购买立减￥2.2
											<br>
										</li>
										<li>
											<i class="zwui-iconfont icon-star-line"></i> 该商家有
											<b>0</b>个粉丝
										</li>
									</ul>
									...
									<div class="zw-module-bigcard-bottombar">
										<div class="zw-module-bigcard-datebar">
											<a href="" target="_blank">农场主页</a> &nbsp;&nbsp;
											<a href="" target="_blank">农小店</a>
			                            </div>
