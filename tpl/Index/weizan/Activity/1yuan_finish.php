...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>{pigcms{$now_activity.name} - 一元抢购 - {pigcms{$config.site_name}</title>
			...
			<div class="oneyuan cf">
				<div class="navBreadCrumb cf">
					<ul class="cf">
						...
						<li>
							<div class="navBreadCrumb_txt"><a href="{pigcms{$config.site_url}/activity/1/all">一元抢购&nbsp;&nbsp;&gt;</a></div>
						</li>
							...
							<div class="m-detail-main-codes">
								...
								<if condition="$_SESSION['user']">
									<if condition="$user_part_list">
										...
										<var>|</var>
										<span class="detail">抢购号码: <volist name="lottery_user_list" id="vo" offset="0" length="7"><b>{pigcms{$vo.number}</b></volist><a class="m-detail-main-codes-viewUserCodesBtn" href="javascript:void(0)">查看更多&gt;&gt;</a></span>
									<else/>
										<p style="text-align:center">您没有参与本次抢购。</p>
									</if>
								<else/>
									<p style="text-align:center"><a class="btn-login" href="javascript:void(0)"><b>请登录</b></a>，查看你的抢购号码！</p>
								</if>
							</div>
											...
											<div class="jion_right">
												<div class="jion_right_div" data-id="{pigcms{$voo['pigcms_id']}">
													<div class="cf">
														...
														<div class="suoyou">所有抢购号码<span></span></div>
													</div>
