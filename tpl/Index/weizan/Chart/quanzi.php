...
//     });
        ...
        function genData(count) {
            ...
            var legendData1 = ['吃货','美食','互联网',"旅游","科技"];
            var legendData2 =['吃货','美食','互联网',"旅游","科技"];
            var   seriesData1= [23321,37420,11020,16870,23400]
            var seriesData = [];
            var legendData=[];
            for (var i = 0; i < 4; i++) {
...
//     });
           ...
           function genData(count) {
               ...
               var legendData1 = ['种植','养殖','牧业',"水产","林业"];
               var legendData2 =['种植','养殖','牧业',"水产","林业"];
               var   seriesData1= [560,444,234,222,100]
               var seriesData = [];
               var legendData=[];
               for (var i = 0; i < 5; i++) {
//                name = Math.random() > 0.65
