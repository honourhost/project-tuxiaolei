                ...
                <div class="hh_features">
                    <div class="hh_features_l">
                        <div class="hh_features_item">
                            <div class="icon-div">
                            	<img src="{pigcms{$static_path}/images/xiansheng/chandi.png" height="35" style="top: 6px;">
                            </div>
                            <div class="hh_features_item_txt">产地直采</div>
                        </div>
                        <div class="hh_features_item">
                            <div class="icon-div">
                            	<img src="{pigcms{$static_path}/images/xiansheng/lvse.png" height="35" style="top: 10px;">
                            </div>
                            <div class="hh_features_item_txt">绿色生态</div>
                        </div>
                        <div class="hh_features_item">
                            <div class="icon-div">
                            	<img src="{pigcms{$static_path}/images/xiansheng/jingxuan.png" height="35" style="top: 10px;">
                            </div>
                    ...
                    <div class="hh_features_r">
                        <div class="hh_features_item">
                            <div class="icon-div">
                            	<img src="{pigcms{$static_path}/images/xiansheng/zhijian.png" height="35" style="top: 10px;">
                            </div>
                            <div class="hh_features_item_txt">严格质检</div>
                        </div>
                        <div class="hh_features_item">
                            <div class="icon-div">
                            	<img src="{pigcms{$static_path}/images/xiansheng/quancheng.png" height="35" style="top: 10px;">
                            </div>
                            <div class="hh_features_item_txt">全程冷链</div>
                        </div>
                        <div class="hh_features_item">
                            <div class="icon-div">
                            	<img src="{pigcms{$static_path}/images/xiansheng/anquan.png" height="35" style="top: 10px;">
                            </div>
                                ...
                                <div class="hh_list_item">
                                    <a href="" class="hh_list_item_img" title="" target="_blank">
                                        ...
                                        <div class="hh_list_item_img_tag">
                                            <div class="hh_mod_icon2" style="background-image: url({pigcms{$static_path}/images/xiansheng/bg-ye.png);"></div>
                ...
                <div class="mod_foot_service">
                    <div class="mod_foot_service_main">
                        <div class="mod_foot_service_desc mod_foot_service_save">
                            <div class="icon-div2">
                            	<img src="{pigcms{$static_path}/images/xiansheng/b-anquan.png" height="40" style="top: 10px;">
                            </div>
                        ...
                        <div class="mod_foot_service_desc mod_foot_service_cold">
                            <div class="icon-div2">
                            	<img src="{pigcms{$static_path}/images/xiansheng/b-quancheng.png" height="40" style="top: 10px;">
                            </div>
                            <div class="mod_foot_service_content">
                        ...
                        <div class="mod_foot_service_desc mod_foot_service_brand">
                            <div class="icon-div2">
                            	<img src="{pigcms{$static_path}/images/xiansheng/b-lvse.png" height="40" style="top: 10px;">
                            </div>
                            <div class="mod_foot_service_content">
                        ...
                        <div class="mod_foot_service_desc mod_foot_service_vip">
                            <div class="icon-div2">
                            	<img src="{pigcms{$static_path}/images/xiansheng/b-chandi2.png" height="40" style="top: 10px;">
                            </div>
                            <div class="mod_foot_service_content">
                        ...
                        <div class="mod_foot_service_desc mod_foot_service_saled">
                           <div class="icon-div2">
                            	<img src="{pigcms{$static_path}/images/xiansheng/b-shouhou.png" height="40" style="top: 10px;">
                            </div>
                            <div class="mod_foot_service_content">
                ...
                <div class="mod_foot_main_box">
                    ...
                    <div class="mod_foot_lk">
                        ...
                        <dl class="mod_foot_lk_item">
                            ...
                            <dd><span>客服电话</span>4006-657-170</dd>
                            <dd><span>服务时间</span>09:00-24:00</dd>
                            <dd><span>反馈邮箱</span>
                                <a href="mailto:xiaonongding@163.com">xiaonongding@163.com</a>
                            </dd>
                        </dl>
                    </div>
                </div>
                <div class="mod_foot_right">2015-2016 © 小农丁™ xiaonongding.com All rights reserved. 鲁ICP备14030686号-1</div>
            </div>
        </div>
    </div>
