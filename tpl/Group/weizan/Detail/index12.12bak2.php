						...
						<div class="detail-unit mt22">
							...
							<div class="detail-cell mt10">
								...
								<p class="no-ico">
									...
									<span class="p-cont">
										<a href="{pigcms{$config.site_url}/merindex/{pigcms{$now_group.mer_id}.html" target="_blank">{pigcms{$now_group.merchant_name}</a>
                                    </span>
								</p>
								<p class="no-ico">
									<a class="nr-qjd-entrance" href="{pigcms{$config.site_url}/merindex/{pigcms{$now_group.mer_id}.html" target="_blank">
							...
							<div class="cell-cont">
								<div class="sj-top-wrap">
									<div class="sj-top">
										<div class="img-box">
											<a href="">
												<img style="width:90px;height:68px;" src="{pigcms{$now_group.person_image}"></div>
										</a>
										<div class="text-box">
											<p class="text-tit">
