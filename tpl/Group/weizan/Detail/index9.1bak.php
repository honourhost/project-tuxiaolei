...
<html>
	<head>
		...
		<if condition="$now_group['tuan_type'] neq 2">
			<title>{pigcms{$now_group.s_name}{pigcms{$config.group_alias_name}|图片|价格|菜单 - {pigcms{$config.site_name}</title>
		<else/>
			<title>{pigcms{$now_group.s_name}{pigcms{$config.group_alias_name} - {pigcms{$config.site_name}</title>
		</if>
					...
					<div class="right-operate">
						<div class="content-wrap">
							...
							<div class="content-unit lm-calendar">
								...
								<div class="unit-nr">
									<label >
										{pigcms{$now_group.person_name}<span class="unit-nr-ft-color unit-nr-line"></span> 
									</label>
								</div>
							</div>
							<div class="content-unit product-option">
					...
					<div class="left-list">
						<div class="detail-cell-local">
									...
									<div class="detail-cell-content">
										<span id="content-top">
											<img src="{pigcms{$static_path}images/xnd_img/content-top.png" />
										</span>
										<p>
											{pigcms{$now_group.person_info}
										</p>
										<span id="content-bottom">
											<img src="{pigcms{$static_path}images/xnd_img/content-bottom.png" />
										</span>
									</div>
								</div>
						<!-- 特卖详情 -->
