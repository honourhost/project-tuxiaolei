				...
				<div class="top-section clearfix">
					<div class="left-tuwen">
						...
						<div class="gallery-bottom clearfix">
							...
							<p class="desc">
								<span class="desc-inner">{pigcms{$now_group.sale_count}</span> 件已售
							</p>
						</div>
						...
						<ul class="tools clearfix">
							...
							<li class="fx">
								<span><div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more">分享</a></div></span>
					...
					<div class="right-operate">
						<div class="content-wrap">
							...
							<div class="content-pad-btm">
								...
								<a class="btn btn_bg02 shou J-component-add-favorite" <if condition="!empty($now_group['is_collect'])">yi</if> fav-id="{pigcms{$now_group.group_id}"><if condition="empty($now_group['is_collect'])">收藏商品<else/>已收藏</if></a>
							</div>
						<script>
						function submitForm(){
							...
							<div class="booking-unit">
								<div class="book-cell enable clearfix">
									...
									<input id="booking" class="book-btn book-now fontYaHei " onClick="window.location.href='{pigcms{$config.site_url}/merindex/{pigcms{$now_group.mer_id}.html';" type="button" value="进入农场主页" />
								...
								<div class="detail-cell-local">
									<div class="detail-cell-header-img">
										...
										<div class="detail-cell-title">
											<h3>____{pigcms{$now_group.merchant_name}____</h3>
											<p>小农丁特色推荐农场</p>
										</div>
				...
				<!--原来的评论-end-->
						...
						<div class="detail-unit">
							...
							<ul class="tab_list" id="tags">
								<li class="selectTag">
									<A onClick="selectTag('tagContent0',this)" href="javascript:void(0)" class="on" data-tab="all">全部</a>
								</li>
								<li>
								    <A onClick="selectTag('tagContent1',this)" href="javascript:void(0)" data-tab="high">好评</a>
								</li>
								<li>
									<A onClick="selectTag('tagContent2',this)" href="javascript:void(0)" data-tab="mid">中评</a>
								</li>
								<li>
									<A onClick="selectTag('tagContent1',this)" href="javascript:void(0)" data-tab="low">差评</a>
								</li>
								<li>
									<A onClick="selectTag('tagContent1',this)" href="javascript:void(0)" data-tab="withpic">有图</a>
								</li>
							</ul>
						...
						<div class="detail-unit merchant-deal-record">
							<h4 class="unit-title fontYaHei">
								...
								<i class="tit-text">商家成交记录 
									<span class="record-count">
										(<span class="record-count-num"><php>echo count($group_order_list);</php></span>)
									</span>
								</i>
							</h4>
							<div class="detail-cell" style="margin-bottom:20px;">
								<table class="record-table">
									...
									<tbody>
										<if condition="$group_order_list">
										<volist name='group_order_list' id="vo">
										<tr>
											...
											<td>
												<php>echo date("Y-m-d H:i:s", $vo['pay_time']);</php>
											</td>
										</tr>
									</volist>
									<else/>
						...
						<div class="lmSideCell gysj">
							...
							<div class="cell-cont">
									...
									<div class="sj-top">
										<div class="img-box">
											<a href="{pigcms{$config.site_url}/merindex/{pigcms{$now_group.mer_id}.html">
												<if condition="$now_group['person_image']">
												<img style="width:90px;height:68px;" src="{pigcms{$now_group.person_image}">
											<else/>
											<img style="width:90px;height:68px;" src="{pigcms{$static_path}images/default.png" />
											</if>										</a></div>
										<div class="text-box">
											<p class="text-tit">
								...
								<div class="sj-phone">
									...
									<ul class="phone-list">
										<li>{pigcms{$now_group.merchant_phone}</li>
									</ul>
