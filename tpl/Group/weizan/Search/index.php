...
.no-result-content{
	...
	<body>
		...
		<div class="zw-module-head-pic back-place">
		  <div class="search_hd">
			找到<span class="keyword">“{pigcms{$keywords}”</span>
			相关{pigcms{$config.group_alias_name}
			<span class="count">{pigcms{$group_count}</span>个
		  </div>
			
		</div>

			<style type="text/css">
				.zw-module-head-pic.back-place {
			  background-image: -webkit-linear-gradient(to top right,#12c4ad,#5dd384);
			  background-image: -moz-linear-gradient(to top right,#12c4ad,#5dd384);
			  background-image: -ms-linear-gradient(to top right,#12c4ad,#5dd384);
			  background-image: linear-gradient(to top right,#12c4ad,#5dd384);
			}
			.zw-module-head-pic {
			  width: 100%;
			  height: 110px;
								...
								<volist name="index_sort_group_list" id="vo">
									<li class="deal <if condition="$i gt 4">last-row<else/>first</if> <if condition="$i%4 eq 0">last-deal</if>">
										<a href="{pigcms{$vo.url}" class="pic" target="_blank">
											<img width="201" height="150" alt="【{pigcms{$vo.prefix_title}】{pigcms{$vo.merchant_name}：{pigcms{$vo.group_name}" title="【{pigcms{$vo.prefix_title}】{pigcms{$vo.merchant_name}：{pigcms{$vo.group_name}" src="{pigcms{$vo.list_pic}"/>
										</a>
										...
										<div class="info">
											...
											<strong class="price" style="text-decoration:none">¥{pigcms{$vo.price}</strong>
											<label class="delete" style="display: none;">门店价{pigcms{$vo.old_price}</label>
										</div>
									</li>
								</volist>
							</ul>
										...
										<div class="category_list_img">
											...
											<div class="datal">
												...
												<div class="deal-tile__detail cf">
													<span class="price" style="text-decoration:none">&yen;<strong>{pigcms{$vo.price}</strong> </span>
