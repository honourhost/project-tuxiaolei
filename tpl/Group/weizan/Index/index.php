...
<html>
	<head>
		...
		<meta http-equiv="X-UA-Compatible" content="IE=Edge">
            ...
            <title>小农丁农产品特卖-{pigcms{$now_category.cat_name}{pigcms{$config.group_alias_name}列表-{pigcms{$config.site_name}</title>
		...
		<div class="zw-module-productlist-unit">
				...
				<div class="zw-module-bigcard-item bigcard-black">
					<a href="{pigcms{$vo.url}" target="_blank">
						<img class="zw-module-bigcard-itemimg" src="{pigcms{$static_path}images/xnd_img/placehold.png" alt="小农丁，F2F，F2F生态农场平台，创意采摘，农业众筹，农场活动，休闲观光，度假村，温泉农庄，科普基地，拓展培训，生态农庄" data-original="{pigcms{$vo.list_pic}" width="360" height="270" title="" alt="{pigcms{$vo.s_name}">
					</a>
					...
					<div class="zw-module-bigcard-iteminfo bigcard-iteminfo-noinfotype">
						<span class="zw-module-bigcard-infoplace"><php> echo getAreaName($vo['area_id']);</php></span>
						...
						<ul class="zw-module-bigcard-infolist">
							<li>
								...
								该特卖产品由{pigcms{$vo.merchant_name}提供<br />
							</li>
							
							<if condition="$vo['wx_cheap']">
							<li style="color: #ffaf30">
								<i class="zwui-iconfont icon-star-line" ></i>
						...
						<div class="zw-module-bigcard-bottombar">
					      ...
					      &nbsp;&nbsp;
								 ...
								 <a href="{pigcms{$config.site_url}/meal/<php>echo getStoreId($vo['mer_id']);</php>.html" target="_blank">
