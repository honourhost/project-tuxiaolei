								...
								<!--商品层-->
									<div class="category_list_img">
										...
										<div class="datal" style="padding:5px 15px 5px;">
											...
											<div class="deal-tile__detail cf">
												<div class="price">¥<strong>{pigcms{$vo.price}</strong></div><span>¥{pigcms{$vo.old_price}</span>
												<div class="sales">已售{pigcms{$vo['sale_count']+$vo['virtual_num']}</div>
											</div>
									...
									<a href="{pigcms{$vo.url}" target="_blank">
										<div class="bmbox" style="bottom: -100%;">
											<div class="bmbox_title"> 该商家有<b>{pigcms{$vo.fans_count}</b>个粉丝</div>
											<div class="bmbox_list">
											<div class="bmbox_list_img"><img class="lazy_img" src="{pigcms{$static_public}images/blank.gif" data-original="{pigcms{:U('Index/Recognition/see_qrcode',array('type'=>'group','id'=>$vo['group_id']))}" style="display: inline;"></div>
											<div class="bmbox_list_li">
												<ul>
													<li class="liu_list_ico_supp open_windows" data-url="{pigcms{$config.site_url}/merindex/{pigcms{$vo.mer_id}.html">商家</li>
													<li class="liu_list_ico_dian open_windows" data-url="{pigcms{$config.site_url}/meractivity/{pigcms{$vo.mer_id}.html">{pigcms{$config.group_alias_name}</li>
													<li class="liu_list_ico_gou open_windows" data-url="{pigcms{$config.site_url}/mergoods/{pigcms{$vo.mer_id}.html">{pigcms{$config.meal_alias_name}</li>
												</ul>
											</div>
