	...
	<body>
		...
		<script type="text/javascript">
			  ...
			  function getBuyList(p){
			  	$.ajax({
					type:'GET',
					url:"{pigcms{:U('Group/getOrderList')}",
					...
					success:function(data){
						if(data.status==1){
							...
							$("#con-page").empty();
							 ...
							 var pre_page=data.info.pre_page;
							 var next_page=data.info.next_page;
							 var total=data.info.total_page;
							 var now_page=data.info.now_page;
							 var pagehtml="";
							 pagehtml+="<a class='page-lf' page='"+pre_page+"' id='pre_page'> <img src='/tpl/Static/weizan/images/xnd_img/iconfont-zuo.png'> </a>";
							 pagehtml+="<a class='page-c'>第<span>"+now_page+"</span>页/共"+total+"页</a>";
							 pagehtml+="<a class='page-rg' page='"+next_page+"' id='next_page'> <img src='/tpl/Static/weizan/images/xnd_img/iconfont-you.png'> </a>";
