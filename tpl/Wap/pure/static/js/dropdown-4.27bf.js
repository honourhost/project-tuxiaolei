$(function(){
	$('.dropdown-toggle').click(function(){
		...
		if($('#dropdown_scroller').height() < ($(window).height() - 97)*0.8){
			...
			myScroll3 = new IScroll('#dropdown_scroller', { probeType: 1,disableMouse:true,disablePointer:true,mouseWheel: false,scrollX: false, scrollY:true,click:false});
		}
	...
	$('.biz-wrapper ul>li, .category-wrapper ul>li').click(function(){
		...
		if($(this).attr('data-has-sub')){
			...
			if($('#dropdown_sub_scroller>div').height() > $('#dropdown_sub_scroller').height()){
				myScroll2 = new IScroll('#dropdown_sub_scroller', { probeType: 1,disableMouse:true,disablePointer:true,mouseWheel: false,scrollX: false, scrollY:true,click:false});
			}
