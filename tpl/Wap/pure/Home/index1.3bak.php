					 ...
					 <div class="addWrap">
						<div class="swipe" id="mySwipe">
							<div class="swipe-wrap">
								<div>
									<a >
									<img class="img-responsive" src="{pigcms{$static_path}/img/xinnian.jpg"/>
									</a>
								</div>
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id=1491">
									<img class="img-responsive" src="{pigcms{$static_path}/img/lg.jpg"/>
									</a>
								</div>
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id=1425">
									<img class="img-responsive" src="{pigcms{$static_path}/img/gouqi.jpg"/>
									</a>
								</div>
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id=1338">
									<img class="img-responsive" src="{pigcms{$static_path}/img/zaohe.jpg"/>
									</a>
								</div>
							</div>
						</div>
