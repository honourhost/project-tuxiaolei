...
<html lang="zh-CN">
	...
	<body>
	<div class="fangjia-bg">
	</div>
	<div class="fangjia">
		<div class="fangjia-close">
			<img src="http://www.xiaonongding.com/tpl/Wap/pure/static/images/fangjia-close.png" />
		</div>
		<div class="fangjia-con">
		  <a href="http://www.xiaonongding.com/tpl/Wap/pure/Home//xnd-tongzhi.html">
		  	<img src="http://www.xiaonongding.com/tpl/Wap/pure/static/images/fangjia-img.png" />
		  </a>
		</div>
	</div>
			...
			<div id="scroller">
					 ...
					 <div class="addWrap">
						<div class="swipe" id="mySwipe">
							<div class="swipe-wrap">
							  	<volist name="pin_main" id="slider_home">
								<div>
									<a href="{pigcms{$slider_home.url}">
									<img class="img-responsive" src="<?php echo "http://www.xiaonongding.com/upload/appslider/"; ?>{pigcms{$slider_home.pic}"/>
									</a>
								</div>
			    ...
			    <div class="youlike tuijian" style="display: none;">
                    ...
                    <dl class="likeBox2 dealcard" style="display: none;">
                        ...
                        <dd class="link-url" data-url="{pigcms{:U('Crowdfunding/detail',array('crowdid'=>$farm['crowd_id']))}">
                            <div class="dealcard-img imgbox"><img
                                        src="{pigcms{$farm.webpic}" alt="{pigcms{$farm.title}"></div>
                            <div class="dealcard-block-right">
                                <div class="brand"> {pigcms{$farm.title}</div>
                                <div class="title">{pigcms{$farm.digest}</div>
                                <div class="price"><span>目标筹款</span><strong>{pigcms{$farm.funds}</strong><span class="strong-color">元</span>
                                    <span class="line-right">已筹{pigcms{$farm.total}元</span></div>
                            </div>
                        </dd>
                        </volist>
                    </dl>
                    <ul style="display: none;">
						<volist name="threeTuiMerchant" id="farm">
							<li>
							<a href="{pigcms{:U('Crowdfunding/detail',array('crowdid'=>$farm['crowd_id']))}">
							<span>{pigcms{$farm.title}</span>
<!--							<i>{pigcms{$farm.person_name}</i>-->
							<div class="tuijian-img" style="background-image: url({pigcms{$farm.webpic});"></div>
							</a>
						</li>
						</volist>
						<div style="clear: both;"></div>
