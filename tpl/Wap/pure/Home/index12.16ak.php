					 ...
					 <div class="addWrap">
						<div class="swipe" id="mySwipe">
							<div class="swipe-wrap">
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Topic&a=index&topic=honghuang">
									<img class="img-responsive" src="{pigcms{$static_path}/img/s04.jpg"/>
									</a>
								</div>
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id=1590">
									<img class="img-responsive" src="{pigcms{$static_path}/img/s01.jpg"/>
									</a>
								</div>
								
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id=1591">
									<img class="img-responsive" src="{pigcms{$static_path}/img/s03.jpg"/>
									</a>
								</div>
								<div>
									<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id=1571">
									<img class="img-responsive" src="{pigcms{$static_path}/img/s02.jpg"/>
									</a>
								</div>
							</div>
						</div>
