...
<link rel="stylesheet" href="{pigcms{$staticPath}{pigcms{$static_path}tpl/com/css/idangerous.swiper.css">
<link href="{pigcms{$staticPath}{pigcms{$static_path}tpl/com/css/iscroll.css" rel="stylesheet" type="text/css" />
<link href="{pigcms{$staticPath}{pigcms{$static_path}tpl/1344/css/cate.css" rel="stylesheet" type="text/css" />

<script src="{pigcms{$staticPath}{pigcms{$static_path}tpl/com/js/iscroll.js" type="text/javascript"></script>
...
<script src="{pigcms{$staticPath}{pigcms{$static_path}tpl/com/js/jquery-1.10.1.min.js" type="text/javascript"></script>
  <script src="{pigcms{$staticPath}{pigcms{$static_path}tpl/com/js/idangerous.swiper-2.1.min.js" type="text/javascript"></script>
  <script>
