...
<link type="text/css" rel="stylesheet" href="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/css/base.css">
 <script type="text/javascript" src="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/js/jquery.min.js"></script>
<script type="text/javascript" src="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/js/touch.js"></script></head>
...
<script type="text/javascript" src="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/js/base.js"></script>
