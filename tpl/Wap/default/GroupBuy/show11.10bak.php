	...
	<body>
		...
		<div class="public-cen">
			...
			<div class="pin-footer">
				<span class="footer-bg"></span>
    				...
    				<else/>
    				<a class="btn-bao right" href="{pigcms{:U('NewGroup/detail',array('group_id'=>$group_buy['group_id']))}">我也要开团</a>
    				</if>
    				<else/>
      				<a class="btn-bao right" href="{pigcms{:U('NewGroup/detail',array('group_id'=>$group_buy['group_id']))}">我也要开团</a>
    				</if>
		...
		<script type="text/javascript">
			var shareData={
						...
						title: <if condition="$username">'{pigcms{$username}喊你一起买"{pigcms{$now_group.s_name}"'<else/>'小农丁喊你一起买"{pigcms{$now_group.s_name}"'</if>,
