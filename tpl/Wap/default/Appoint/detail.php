			...
			<if condition="$appoint_product_list">
				<dl class="list">
					...
					<dd style="padding:5px 10px 15px 10px;">
						<div class="bigclass1" style="box-sizing: border-box;    width: 100%;    display: inline-table;">
							<volist name="appoint_product_list" id="val">
								<div class="class1" style="float:left;width:50%;padding:0 5px;margin-top:10px;box-sizing:border-box;">
									<div class="class2" style="padding: 4px 10px;font-size: 13px;line-height: 38px;height: 38px;color: #333;border-radius: 2px;border-color: #d7d7d7;    border: 1px solid #ccc;">
