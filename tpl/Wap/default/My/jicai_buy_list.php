...
<dl class="list" style="margin-top:10px;display: none;">
    <dd>
        <ul class="orderindex">
        ...
        <ul>
            <if condition="$group_buy_list">
                <volist name="group_buy_list" id="group_buy">
                    <li>
                        <a href="">
                            <div class="list-wx-img" style="background-image: url({pigcms{$group_buy.pic});">
                            </div>
...
<!--                                </a>-->
                            ...
                            <div style="width: 100%; text-align: right; padding: 5px 0px; ">
                                <span >订单时间：<?php echo date("Y-m-d H:i:s",$group_buy['pay_time']);?></span>
                            </div>
                        </a>
                        <style>
                            .tuanzhang3{
                ...
                <if condition ="$group_buy_list">
                    ...
                    <div class="s_empty" style="display:block;">您暂时没有集采订单</div>
                </if>
        </ul>
        <div style="clear: both;"></div>
    </div>
