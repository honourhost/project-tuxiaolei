...
<body id="index">
        ...
        <div class="wrapper-list">
					...
					<dd>
						<dl>
							...
							<!--	<dd class="dd-padding coupons-code">
                                ...
                                <dd class="dd-padding coupons-code">
                                    快递单号：{pigcms{$now_order.express_id}<small><a href="{pigcms{:U('My/express_query',array('expresscode'=>$now_order['express_info']['juhecode'],'expressid'=>$now_order['express_id']))}" target="_blank" style="color:#1B9C46;">查看物流信息</a></small>
                                </dd>
							</if>
						</dl>
					</dd>
			...
			<if condition="$config['group_order_cancle']">
