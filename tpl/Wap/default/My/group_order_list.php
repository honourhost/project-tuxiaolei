        ...
        <dl class="list" style="margin-top:0px;">
		    <dd>
				<ul class="orderindex">
					...
					<li><a href="{pigcms{:U('My/group_order_list',array('status'=>233))}" class="react <if condition="$_GET['status'] == '233'">hover</if>">
						<i class="text-icon">⌹</i>
						<span>拼团订单</span>
					</a>
					</li>
			                    ...
			                    <div class="dealcard-block-right">
			                        ...
			                        <weak>
			                        	...
			                        	<elseif condition="empty($vo['status'])"/>
			                        		<if condition="$vo['tuan_type'] == '2'">
			                        		<a class="btn btn-weak color-gray">已付款</a>
			                        		<else/>
			                        		<a class="btn btn-weak color-gray">未消费</a>
			                        		</if>
			                        	<elseif condition="$vo['status'] == '1'"/>
			                        		<if condition="$vo['user_confirm']==0">
												<a class="btn btn-weak" href="{pigcms{:U('My/group_feedback',array('order_id'=>$vo['order_id']))}">确认收货</a>
												<else/>
