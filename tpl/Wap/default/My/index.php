...
<body>
	...
	<div>
		<a class="my-account" href="{pigcms{:U('My/myinfo')}">
			...
			<div class="user-info more more-weak">
				...
				<p class="umoney">余额：<strong>{pigcms{$now_user.distribute_money}</strong> 元 &nbsp;&nbsp;&nbsp <span>积分：<strong>{pigcms{$now_user.score_count}</strong> 分</span></p>
	...
	<dl class="list">
        ...
        <dd >
            <a class="react" href="{pigcms{:U('My/crowd_buy_list',array('status'=>1))}">
                <div class="more more-weak">
        ...
        <dd >
            <a class="react" href="{pigcms{:U('My/jicai_buy_list',array('status'=>1))}">
                <div class="more more-weak">
	...
	<dl class="list">
		...
		<dd>
			<a class="react" href="{pigcms{:U('My/getdisnew')}">
				<div class="more more-weak">
...
<!--			</a>-->
        ...
        <dd>
            <a class="react" href="{pigcms{:U('My/cardmoneyrecharge')}">
                <div class="more more-weak">
