	...
	<div class="xnd-phone-po-bg"></div>
		<div class="xnd-phone-po-div">
			...
			<a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Topic&a=gansu">
				<img src="{pigcms{$static_path}images/phone-huodong.png" class="po-img" />
			</a>
	</div>
	</if>
	...
	<dl class="list">
		...
		<dd>
			<a class="react" href="{pigcms{:U('My/meal_order_list')}">
				<div class="more more-weak">
					<i class="text-icon order-jiudian order-icon" style="background-color:#0092DE;">订</i>小店订单<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<!-- <dd>
