...
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}vip/widget/navigator/navigator.default.css"/>
<!--皮肤文件，若不使用该皮肤，可以不加载-->
            ...
            <div class="tab-content">
                ...
                <div class="tab-panel" id="cpxq">
                    <div class="all" id="menuList">
                        <ul id="ul_type284">
                            <volist name="res.goods" id="group">
                                <li id="dish_li2953">
                                    <div class="cen">
                                        ...
                                        <div class="list-cons">
                                            <div class="left-right">
                                                ...
                                                <div class="price_wrap">
                                                    <strong><span
                                                                class="unit_price">&yen;<?php echo explode('.', $group['price'])[0]; ?>
                        ...
                        <li id="dish_li2953" style="display: none;">
                            <div class="cen">
                                <div class="list-imgs shop-img" style="background-image: url(http://www.xiaonongding.com/upload/group/000/000/890/59881fecc4b50.jpg);">
                                    <input type="hidden" class="goodprice" value="288.00">
                                    <input type="hidden" class="goodname" value="达拉斯庄园干红葡萄酒">
                                    <input type="hidden" class="gooddigest" value="达拉斯红酒
规格：500ml.
精心种植，层层筛选。不是每一颗葡萄都能成为佳酿，感受呼吸和发酵的力量，成就醇厚、圆润的口感。精致生活，从一杯好酒开始。">
                                    <input type="hidden" class="goodimage" value="http://www.xiaonongding.com/upload/group/000/000/890/s_599e2ec5d902a.jpg">
                                </div>
                                <div class="list-cons">
                                    <div class="left-right">
                                        <h5 >达拉斯庄园干红葡萄酒</h5>
                                        <p>法国 波尔多</p>
                                        <div class="price_wrap">
                                            <strong><span class="unit_price">¥288
                                               <input type="hidden" class="tureunit_price" value="288.00"></span>
                                                <del>¥398.00</del>
                                            </strong>
                                            <input autocomplete="off" class="thisdid" type="hidden" value="3058">
                                            <div class="price_wrap2">
                                                <div class="fr" max="-1">
                                                    <a href="javascript:void(0);" class="btn plus" data-num="0"></a>
                                                </div>
                                                <input autocomplete="off" class="number" type="hidden" name="dish[3058]" value="0">
                                            </div>
...
<script>
    $(document).ready(function () {
        $("#ul_type284").on("click",".list-imgs", function () {
    ...
    $(document).ready(function () {
        $(".mytab").bind("click",function () {
            ...
            $.get("{pigcms{:U('Vip/vipgoodsajax')}",{cat_id : catid},function (data) {
                $("#ul_type284 li").remove();
                $("#ul_type284").append(data);
                return;
            });
              setTimeout(function () {
