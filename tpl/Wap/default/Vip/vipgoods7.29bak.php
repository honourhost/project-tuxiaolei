        ...
        <div class="right" id="usermenu">
            <div class="all" id="menuList">
            	...
            	<div class="nav-banner">
					<img src="{pigcms{$static_path}vip/nav01.jpg" />
				</div>
                <ul id="ul_type284">
                    ...
                    <volist name="groups" id="group">
                        ...
                        <li id="dish_li{pigcms{$group.group_id}">
                            ...
                            <div class="list-cons">
                                <div class="list-left">
                                    <img src="{pigcms{$group.thumb}" />
                                </div>
                                <div class="left-right">
                                    <h4>壹加壹牛肉</h4>
										<h5>{pigcms{$group.s_name}</h5>
										<p>增肌强身精选带骨腹肉增肌强身精选带骨腹肉</p>
                        ...
                        <li id="dish_li{pigcms{$group.group_id}">
                            ...
                            <div class="list-cons">
                                ...
                                <div class="left-right">
                                    ...
                                    <div class="price_wrap">
                                        <strong>￥<span class="unit_price"><?php echo  explode('.', $group['price'])[0];?><i>.<?php echo  end(explode('.', $group['price']));?></i><input type="hidden" class="tureunit_price" value="{pigcms{$group.price}"></span>
                                            <del>&yen;:{pigcms{$group.old_price}</del>
                                        </strong>
                                        <input autocomplete="off" class="thisdid" type="hidden" value="{pigcms{$group.group_id}">
                                        <div class="price_wrap2">
                        ...
                        <li id="dish_li{pigcms{$group.group_id}">
                            ...
                            <div class="list-cons">
                                ...
                                <div class="left-right">
                                    <h4>{pigcms{$group.s_name}</h4>
                                    <div class="price_wrap">
                                        <strong>￥<span class="unit_price">{pigcms{$group.price}<i style="display: none;">.00</i><input type="hidden" class="tureunit_price" value="{pigcms{$group.price}"></span>
                                            <del>&yen;:{pigcms{$group.old_price}</del>
                                        </strong>
                                        <input autocomplete="off" class="thisdid" type="hidden" value="{pigcms{$group.group_id}">
                                        <div class="price_wrap2">
