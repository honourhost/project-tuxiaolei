...
<div data-role="container" class="container">
    <section data-role="body">
        ...
        <div class="right" id="usermenu">
                            ...
                            <div class="list-cons">
                                ...
                                <div class="left-right">
                                    ...
                                    <div class="price_wrap">
                                        <strong>&yen;<span class="unit_price">{pigcms{$group.price}<i>.00</i><input type="hidden" class="tureunit_price" value="{pigcms{$group.price}"><b>会员品鲜价</b></span>
            ...
            <div class="list-img">
            	<img src="{pigcms{$static_path}vip/list-footer.jpg">
            </div>
