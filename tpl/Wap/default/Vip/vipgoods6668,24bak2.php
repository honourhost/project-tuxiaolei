...
<!--组件依赖css begin-->
	...
	<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}vip/widget/navigator/navigator.default.css" /><!--皮肤文件，若不使用该皮肤，可以不加载-->
	<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}vip/widget/navigator/navigator.iscroll.default.css" /><!--皮肤文件，若不使用该皮肤，可以不加载-->
	<!--组件依赖css end-->
	<!--组件依赖js begin-->
	...
	.switch-tab li a{
        ...
        <div class="list-nav" >
            <div class="navs" id="nav-smartSetup">
                <ul class="switch-tab">
                    <volist name="res" id="cat" key="index">
                        <if condition="$index eq 1">
                            ...
                            <else />
                            <li>
                                <a href="javascript:; ">{pigcms{$cat.cat_name}</a>
                            </li>
                        </if>
                    </volist>
                    ...
                    <if condition="$index eq 1">
                        <div class="tab-panel" id="cpxq">
                            <div class="all" id="menuList">
                                <ul id="ul_type284">
                                    <volist name="cat.goods" id="group">
                                        <li id="dish_li2953">
                                            <div class="cen">
                                                <div class="list-imgs shop-img" style="background-image: url({pigcms{$group.pic});">
                                                ...
                                                <div class="list-cons">
                                                    <div class="left-right">
                                                        ...
                                                        <div class="price_wrap">
                                                            <strong><span class="unit_price">&yen;<?php echo  explode('.', $group['price'])[0];?><input type="hidden" class="tureunit_price" value="{pigcms{$group.price}"></span>
