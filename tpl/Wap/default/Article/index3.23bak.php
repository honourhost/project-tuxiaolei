	...
	<head>
				...
				<div id="page-content" class="content">
					<div id="img-content">
						...
						<div class="rich_media_tool" id="js_toobar" style="color: #888;">
							<a class="media_tool_meta meta_primary" href="{pigcms{$nowImage['url']}">阅读原文</a>点击数：{pigcms{$nowImage['count']}
						</div>
						</if>
					</div>
				</div>
		...
		<div style="width: 100%; height: 50px;"></div>
			<div class="header-top">
				<a href="http://www.xiaonongding.com/app/download.html">
				<span class="header-gz">下载</span>
				<div class="header-logo">
					<img src="{pigcms{$static_path}images/logo.png" />
				</div>
				<h3 style="font-size: 14px; color: #fff;">下载小农丁 APP<br />抢百元红包</h3>
				</a>
				<div style="clear: both;"></div>
			</div>
