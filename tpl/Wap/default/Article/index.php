		...
		<div class="rich_media container">
			...
			<div class="rich_media_inner content" style="min-height: 431px;">
				...
				<div class="rich_media_meta_list">
					<em id="post-date" class="rich_media_meta text" style="font-size: 16px;"><a href="{pigcms{$config.site_url}/wap.php" class="rich_media_xnd">兔小蕾</a>{pigcms{$nowImage['now']}</em> 
							...
							<div class="new-more" >
								...
								<ul class="list01">
									<volist name="tuijian" id="art">
										<li><a href="{pigcms{:U('Article/index',array('imid'=>$art['pigcms_id']))}"><span><?php echo  date("Y-m-d",$art['dateline']);?></span><h4>{pigcms{$art.title}</h4></a></li>
									</volist>
...
wx.ready(function () {
    ...
    media.play();
						...
						<div class="rich_media_tool" id="js_toobar" style="color: #f6d95a;">
							<a class="media_tool_meta meta_primary" href="{pigcms{$nowImage['url']}">阅读原文</a>阅读量：<php> echo $nowImage['count']*21;</php>
						</div>
		...
		<div style="width: 100%; height: 50px;"></div>
			<div class="header-top">
				...
				<h3 style="font-size: 14px; color: #fff;">{pigcms{$config.article_bottom_title}<br />{pigcms{$config.article_bottom_digest}</h3>
				</a>
				<div style="clear: both;"></div>
			</div>
		...
		<script type="text/javascript">
			var shareData={
						...
						link: "{pigcms{$config.site_url}{pigcms{:U('Article/index', array('imid' => $nowImage['pigcms_id'],'share_distribution_id'=>$_SESSION['share_distribution_id']))}",
						<else/>
