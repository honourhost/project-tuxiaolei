					...
					<volist name="category_groupbuy_list" id="groupbuy">
						<div class="nearby_group_detail">
							<div class="nearby_g_img">
								<img class="nearby_g_owner_img" src="{pigcms{$groupbuy.list_pic}">
							</div>
							<div class="nearby_g_button">
								<div class="nearby_g_info">
									<div id="nearby_g_owner">{pigcms{$groupbuy.group_name}</div>
									<div class="nearby_g_left_user_num">还差
										<?php echo $groupbuy['need_num']-$groupbuy['react_num'];?>人成团</div>
									<div id="nearby_g_address"></div>
									<!-- <div id="nearby_g_left_time">剩余 -->
										<!--ms-if-->
										<!--ms-if-->
										<!-- <span id="hour_show">0:</span>
										<span id="minute_show">0:</span>
										<span id="second_show">0</span>结束
									</div> -->
								</div>
							</div>
							<div class="qucantuan">
