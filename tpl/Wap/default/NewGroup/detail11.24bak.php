				...
				<div class="details-faqi">
					...
					<volist name="category_groupbuy_list" id="groupbuy">
						...
						<div class="nearby_group_detail">
							...
							<div class="qucantuan">
								<a href="{pigcms{:U('Groupbuy/show',array('sun_id'=>$groupbuy['sun_id']))}"><span><if condition="$now_group['is_lottery_group_buy']">试试手气<else/>去参团</if></span><img src="{pigcms{$static_path}img/qucantuan_arrow.png"></a>
							</div>
