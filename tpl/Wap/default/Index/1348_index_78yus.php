...
<link type="text/css" rel="stylesheet" href="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/css/reset.css">
<link type="text/css" rel="stylesheet" href="{pigcms{$staticPath}{pigcms{$static_path}tpl/1348/css/base.css">
 <script type="text/javascript" src="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/js/jquery.min.js"></script>
<script type="text/javascript" src="{pigcms{$staticPath}{pigcms{$static_path}tpl/1334/js/touch.js"></script>
</head>
...
<div style="height: 34px;line-height: 34px;font-size: 12px;background: #e3e2dd;text-align: center;color: #999;margin-top:6px">
