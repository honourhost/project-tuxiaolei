    ...
    <section data-role="body">
		...
		<if condition="!empty($totalmoney) AND $totalnum gt 0">
		   <div class="line icons">
                <span>订单详情</span>
                <label>{pigcms{$totalnum}个商品，共<strong style="color:#FF4907">{pigcms{$totalmoney}</strong>元</label>
			</div>
         </if>
            ...
            <div class="line icons status" style="display: none;">
                <i></i>
                <span>餐位情况</span>
                 <label>
                    <div class="ui_select">
