	...
	<div data-role="container" class="container storeDetails">
		...
		<section data-role="body">
			<ul class="linklist">
				...
				<li>
					<a href="{pigcms{:U('Food/shop_detail', array('mer_id' => $mer_id, 'store_id' => $store_id))}">农场简介<span class="right_adron"></span></a>
				</li>
			</ul>
			<div class="btndiv">
				...
				<div style="width: 100%;">
					<a href="{pigcms{:U('Food/menu', array('mer_id' => $mer_id, 'store_id' => $store_id))}" class="order"><span class="btn green bigfont big">进入农小店</span></a>
				</div>				
			</div>
		</section>
