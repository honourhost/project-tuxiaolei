...
<div class="max-width">
    <div class="logo-xnd">
        <img src="{pigcms{$static_path}img/logo.png" />
    </div>
    <div class="xnd-zhuanzhang">
        <h3>转账金额</h3>
        <div class="xnd-je">
            <img src="{pigcms{$static_path}img/rmb.png" />
            <input type="number" step="0.01" name="moneynothide" placeholder="请输入转账金额" />
        </div>
    </div>
    <div class="zz-btn">
        <a>转账</a>
        <form method="post"  style="display: none;" id="moneyform" action="{pigcms{:U('Qrpay/test2')}">
