...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/new-xnd-duanwu.css"/>
...
<body style="background: url({pigcms{$static_path}images/yang/body-bg.jpg);">
	<style>
		.duanwu-img{
			width: 100%;
		}
		...
		.phone-gansu-tj-title{
			width: 100%;
		}
		.phone-gansu-tj-title img{
			width: 100%;
		}
	</style>
<div class="public_cen">
    <div class="duanwu-img">
    	<img src="{pigcms{$static_path}/images/yang/wfk.jpg">
    </div>
        ...
        <if condition="$k eq 1">
            ...
            <if condition="$goodslist">
                ...
                <div class="phone-gansu-tj-nav">
                    <div class="phone-gansu-tj-title" style="background: #51861c;">
                    	<img src="{pigcms{$static_path}images/yang/nav-img0<?php echo $k;?>.jpg">
                    </div>
                    <ul>
            ...
            <if condition="$goodslist">
                ...
                <div class="phone-gansu-tj-nav">
                    <div class="phone-gansu-tj-title" style="background: #51861c;">
                        <img src="{pigcms{$static_path}images/nav-img0<?php echo $k;?>.jpg">
                    </div>
                    <ul>
