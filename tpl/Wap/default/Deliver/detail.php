...
<div id="wrapper" class="">
    <div id="fis_elm__2">
        <div id="common-widget-nav" class="common-widget-nav ">
            ...
            <div class="right-slogan "> <a class="tel-btn" href="tel:{pigcms{$supply['phone']}"><i class="icon-phone"></i></a> </div>
        </div>
    </div>
    <!--<div id="fis_elm__3">
    ...
    <div id="fis_elm__4">
        <div id="order-widget-orderdetail" class="order-widget-orderdetail">
            <div id="fis_elm__5">
            ...
            <div id="fis_elm__2" style="margin-top:5px;">
                <div id="common-widget-nav" class="common-widget-nav " <php>if($supply[status] != 5):</php> onclick="operate()" style="background-color: #EE3968;margin-top: 5px;"<php>endif;</php> >
                        ...
                        <a href="javascript:void(0)" <php>if($supply[status] != 5):</php>style="color: #fff;font-weight: bold;"<php>endif;</php>>
                            <php>
                                switch($supply['status']) {
                                    ...
                                    case 2: echo '已接单，准备取货..';break;
                                    case 3: echo '已取货，准备配送..';break;
                                    case 4: echo '已送达，配送完成..';break;
                                    case 5: echo '配送完成';break;
                                }
                            </php>
                        </a>
                    </div>
