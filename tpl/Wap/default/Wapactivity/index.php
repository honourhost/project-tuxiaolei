...
<head>
	...
	<if condition="$is_wexin_browser">
		<title>活动列表</title>
	<else/>
		<title>活动列表_{pigcms{$config.site_name}</title>
	</if>
...
<body id="index">
		...
		<script type="text/javascript">
			var shareData={
						imgUrl: "{pigcms{$activity_list.0.list_pic}", 
						link:   "{pigcms{$config.site_url}/wap.php?g=Wap&c=Wapactivity&a=index",
						title:  "活动列表_{pigcms{$config.site_name} {pigcms{$config.seo_title}",
