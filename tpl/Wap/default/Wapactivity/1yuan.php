...
<body id="index">
			    ...
			    <dl class="list list-in">
					...
					<dd class="dd-padding m-detail-userCodes">
						<if condition="$lottery_user_list">
							...
							<p class="codes">抢购号码：<volist name="lottery_user_list" id="vo" offset="0" length="6"><b>{pigcms{$vo['number']+10000000}</b></volist><a class="m-detail-userCodes-viewCodesBtn" href="javascript:void(0)">查看全部</a></p>
						<else/>
							<p class="m-detail-userCodes-blank">您没有参与本次抢购哦！</p>
						</if>
					</dd>
			    </dl>
			</div>
		...
		<script type="text/javascript">
			var shareData={
						...
						link:   "{pigcms{$config.site_url}/wap.php?g=Wap&c=Wapactivity&a=detail&id={pigcms{$now_activity.pigcms_id}",
						title:  "{pigcms{$now_activity.title} {pigcms{$config.seo_title}",
						desc:   "{pigcms{$now_activity.title} {pigcms{$config.seo_description}"
			};
		</script>
