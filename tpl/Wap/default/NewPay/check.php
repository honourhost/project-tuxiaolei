...
<div class="wrapper-list">
        ...
        <dl class="list">
            <dd>
                <dl>
                    ...
                    <dd class="kv-line-r dd-padding">
                        <h6>可用帐户余额：</h6><p>{pigcms{$now_user.now_money}元</p>
                    </dd>
    ...
    <form action="{pigcms{:U('NewPay/go_pay',array('showwxpaytitle1'=>1,'sun_id'=>$_GET['sun_id']))}" method="POST" id="pay-form" class="pay-form">
        ...
        <div id="pay-methods-panel" class="pay-methods-panel">
            <php>if($cheap_info['can_cheap']){</php>
            <if condition="($pay_money-$cheap_info['wx_cheap']) gt 0">
