...
<div data-role="container" class="container myMenu">
    <section data-role="body">
        <div class="main" >
			...
			<span>
				...
				<a href="{pigcms{:U('Jicai/menu', array('mer_id' => $mer_id, 'orid' => $orid))}" class="add">加商品</a>
    ...
    <footer data-role="footer">
        <nav class="g_nav">
            <div>
                ...
                <if condition="isset($level_off) AND !empty($level_off)">
                    <span><span class="money"><del>￥<label id="allmoney">0</label></del>&nbsp;￥<label id="levelallmoney">0</label></span>/<label id="menucount">0</label>个商品</span><span style="margin-left: 60px;color: #FD7008;">{pigcms{$level_off['offstr']}</span>
                    <else />
    ...
    <div class="layer popup">
        <div class="dialogX">
            <div class="content">
                <div class="title">清空商品</div>
                <div class="message">您是否要清空该商品？</div>
            </div>
            <div class="button">
                <a class="cancel" href="javascript:cancel();">取消</a>
                <a href="{pigcms{:U('Jicai/cart', array('mer_id' => $mer_id,'isclean'=>1))}">确定</a>
            </div>
        </div>
    </div>
</div>
