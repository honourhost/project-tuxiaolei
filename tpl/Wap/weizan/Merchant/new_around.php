        ...
        <div id="container">
			...
			<div class="nav-bar">
			    <ul class="nav" style="padding:0rem .2rem;">
		            <li class="dropdown-toggle caret1 category"  style="text-align: left"><span class="nav-head-name">{pigcms{$adress}</span></li><a href="{pigcms{:U('Merchant/around')}" class="modify">修改</a>
			    </ul>
			</div>		 
