	...
	<dl class="list">
        ...
        <dd>
			<a class="react" href="{pigcms{:U('My/appoint_order_list')}">
				<div class="more more-weak">
					<i class="text-icon order-jiudian order-icon" style="background-color:#37caad;">预</i>预约订单<span class="more-after"></span>
				</div>
			</a>
		</dd>
	</dl>
	<dl class="list">
		<dd>
			<a class="react" href="{pigcms{:U('My/group_collect')}">
				<div class="more more-weak">
					<i class="text-icon order-fav order-icon" style="background-color:#F5716E;">喜</i></i>我的收藏<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
			<a class="react" href="{pigcms{:U('My/follow_merchant')}">
				<div class="more more-weak">
					<i class="text-icon order-fav order-icon" style="background-color:#f84848;">商</i>我关注的商家<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
	...
	<dl class="list">
		<dd>
			<a class="react" href="{pigcms{:U('My/card_list')}">
				<div class="more more-weak">
					<i class="text-icon order-card order-icon">惠</i>我的优惠券<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
		...
		<dl class="list">
			<dd>
				<a class="react" href="{pigcms{:U('Classify/myCenter')}">
					<div class="more more-weak">
						<i class="text-icon order-card order-icon">信</i>我的发布<span class="more-after"></span>
					</div>
				</a>
			</dd>
		</dl>
