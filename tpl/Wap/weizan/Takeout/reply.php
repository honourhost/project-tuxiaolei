...
<head>
    <meta charset="utf-8"/>
		<title>{pigcms{$store['name']}的评价</title>
...
window.shareData = {  
            ...
            "moduleID":"0",
            "imgUrl": "", 
            "sendFriendLink": "{pigcms{$config.site_url}{pigcms{:U('Takeout/reply', array('store_id' => $store['store_id']))}",
            "tTitle": "{pigcms{{pigcms{$store['name']}}的评价",
            "tContent": ""
};
</script>
