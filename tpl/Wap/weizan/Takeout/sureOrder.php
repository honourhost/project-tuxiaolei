...
<div class="container">
	...
	<footer class="order_fixed">
		<div class="fixed">
			...
			<div>
				<span class="comm_btn disabled">还差 <span id="sendCondition"><if condition="$store['basic_price'] && $store['delivery_fee_valid'] eq 0">{pigcms{$store['basic_price']}<else/>0</if></span> 起送</span>
