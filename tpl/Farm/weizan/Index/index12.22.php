		...
		<div id="qyer_banner" class="banner">
			<div id="carousel" class="carousel">
				...
				<ul class="carousel-data">
					...
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="天水">
						<input class="bannerurl" type="hidden" value="">
					...
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="杭州">
						<input class="bannerurl" type="hidden" value="">
			...
			<div id="search" class="search active-place">
				...
				<div class="panel">
					...
					<div class="panel-inner">
						<div class="panel-cont">
							...
							<div class="plan">
								<p>做自己的农场主！</p>
								<a class="link" target="_blank" href=""><i class="iconfont icon-jiahao"></i> 创建农场</a>
								<a class="link custom" target="_blank" href=""><i class="iconfont icon-custom"></i> 管理农场</a>
							</div>
							<div class="z z_search_box">
								<div class="input-control">
									<form class="z_search_form" target="_blank" action="" data-action="" method="get">
										...
										<input class="txt zsearch_txt" type="text" placeholder="搜索农场" autocomplete="off" name="kw">
										<button class="btn" type="submit">搜索</button>
									</form>
								</div>
							</div>
				...
				<div class="q-layer q-layer-placesearch-history">
					...
					<div class="placesearch-history-cont hot">
						...
						<a href="" target="_blank">天水</a>
						<a href="" target="_blank">潍坊</a>
						<a href="" target="_blank">西安</a>
						<a href="" target="_blank">定西</a>
					</div>
				</div>
