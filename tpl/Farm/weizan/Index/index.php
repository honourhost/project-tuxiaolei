...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>小农丁生态农场-农场列表-{pigcms{$config.site_name}</title>
	...
	<body class="">
		...
		<link href="{pigcms{$static_path}css/xnd_css/headerfoot_black.css" rel="stylesheet" />
		<script src="{pigcms{$static_path}js/xnd_js/headerfoot_black.min.js" async="async"></script>
		<div class="q-layer-header">
			<div class="header-inner">
				<a href="/">
					<img alt="小农丁" class="logo" src="{pigcms{$static_path}images/xnd_img/index_logo_small.png"  alt="小农丁，F2F，F2F生态农场平台，创意采摘，农业众筹，农场活动，休闲观光，度假村，温泉农庄，科普基地，拓展培训，生态农庄"  height="18" />
				</a>
				<div class="nav">
					<ul class="nav-ul">
		...
		<div class="zw-header">
			<div class="zw-header-wrap">
				<p class="zw-header-logo">
					<a href="/">
						<img alt="小农丁"  src="{pigcms{$static_path}images/xnd_img/header_logo.gif" height="34" align="">
					</a>
				</p>
				<style>
		...
		<div id="qyer_banner" class="banner">
			<div id="carousel" class="carousel">
				...
				<ul class="carousel-data">
					<php>$list=getAdvList("farm_top",1);</php>
					<volist name="list" id="adv" key="k">
					<if condition="$k eq 1">
						<li>
						<input class="bannerimg" type="hidden" value="{pigcms{$config.site_url}/upload/adver/{pigcms{$adv.pic}">
						...
						<input class="bannerlink" type="hidden" value="{pigcms{$adv.url}">
						<div class="text">
							<a href="{pigcms{$adv.url}" target="_blank">
								<p><strong>{pigcms{$adv.name}</strong></p>
								<p>{pigcms{$adv.desc}</p>
							</a>
						</div>
					</li>
											...
											<div class="photo">
												<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
													<if condition="$farm['merchant_theme_image']">
														<img class="lazy" src="{pigcms{$farm.merchant_theme_image}" alt="小农丁，F2F，F2F生态农场平台，创意采摘，农业众筹，农场活动，休闲观光，度假村，温泉农庄，科普基地，拓展培训，生态农庄" width="275" height="185" style="display: inline;">
														<else/>
													...
													<span class="avatar">
														<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
															<if condition="$farm['person_image']">
																<img class="lazy" alt="小农丁，F2F，F2F生态农场平台，创意采摘，农业众筹，农场活动，休闲观光，度假村，温泉农庄，科普基地，拓展培训，生态农庄" src="{pigcms{$farm.person_image}" style="display: inline;">
																<else/>
			...
			<div class="zw-footer-wrap">
				<div class="zw-footer-line1 clearfix">
					<div class="zw-footer-intro">
						<p class="logo"><img alt="小农丁" src="{pigcms{$static_path}images/xnd_img/foot_logo.png"></p>
						<p class="text">
