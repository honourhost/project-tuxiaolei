		...
		<div id="qyer_banner" class="banner">
			<div id="carousel" class="carousel">
				...
				<ul class="carousel-data">
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="古巴">
						<input class="bannerurl" type="hidden" value="">
						<input class="itemid" type="hidden" value="1412244">
						<input class="bannerlink" type="hidden" value="">
						<div class="text">
							<a href="" target="_blank">
								<p><strong>【墨西哥与古巴】远古和近现代的穿越之旅</strong></p>
								<p>陈曦Stanley</p>
							</a>
						</div>
					</li>
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="匈牙利">
						<input class="bannerurl" type="hidden" value="">
						<input class="itemid" type="hidden" value="1335307">
						<input class="bannerlink" type="hidden" value="">
						<div class="text">
							<a href="" target="_blank">
								<p><strong>【欧洲流浪记】从冰岛到匈牙利，记独自行走在欧洲10国40城的两个月</strong></p>
								<p>哈利的隐形斗篷</p>
							</a>
						</div>
					</li>
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="你要去哪儿？">
						<input class="bannerurl" type="hidden" value="">
						<input class="itemid" type="hidden" value="1386910">
						<input class="bannerlink" type="hidden" value="">
						<div class="text">
							<a href="" target="_blank">
								<p><strong>在冰岛写诗，致绝美，致遗憾|2015十一逆时针环岛13天</strong></p>
								<p>farname</p>
							</a>
						</div>
					</li>
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="马尔代夫">
						<input class="bannerurl" type="hidden" value="">
						<input class="itemid" type="hidden" value="575">
						<input class="bannerlink" type="hidden" value="">
						<div class="text">
							<a href="" target="_blank">
								<p><i class="iconfont icon-jinnang"></i> <strong>穷游锦囊 | 马尔代夫酒店</strong></p>
								<p>在人间天堂选一张舒适的床 听风 观海 看夕阳</p>
							</a>
						</div>
					</li>
					<li>
						<input class="bannerimg" type="hidden" value="http://www.xiaonongding.com/upload/extension/2015/07/55a4fa26dd7e1.png">
						<input class="bannertext" type="hidden" value="帕劳">
						<input class="bannerurl" type="hidden" value="">
						<input class="itemid" type="hidden" value="270">
						<input class="bannerlink" type="hidden" value="">
						<div class="text">
							<a data-bn-ipg="index-top-guide-270" href="" target="_blank">
								<p><i class="iconfont icon-jinnang"></i> <strong>穷游锦囊 | 帕劳</strong></p>
								<p>潜入七色海水，畅游上帝的水族箱</p>
							</a>
						</div>
					</li>
			...
			<div id="search" class="search active-place">
				<div class="tab">
					<a class="tab-place" href="javascript:;" data-type="place">目的地</a>
					<a class="tab-plan" href="javascript:;" data-type="plan">做行程</a>
					<a class="tab-z" href="javascript:;"  data-type="z">买折扣</a>
				</div>
				<div class="panel">
					<em class="arrow"></em>
					<div class="panel-inner">
						<div class="panel-cont">
							<div class="place place_search_box">
								<div class="input-control">
									<form class="place_search_form" target="_blank" action="" method="post">
										<input class="txt placesearch_txt" type="text" placeholder="你要去哪儿？" autofocus autocomplete="off">
							...
							<div class="z z_search_box">
								<div class="input-control">
									<form class="z_search_form" target="_blank" action="" data-action="" method="get">
										<input type="hidden" name="_type" value="search">
										<input type="hidden" name="action" value="list">
										<input class="txt zsearch_txt" type="text" placeholder="搜索目的地/折扣类型/关键词" autocomplete="off" name="kw">
										<button class="btn" type="submit">搜索</button>
									</form>
								</div>
							</div>
				...
				<div class="condition-line clearfix" data-lmtype="mdd">
					...
					<div class="condition-wrap clearfix">
						...
						<div class="condition-list-wrap">
							<ul class="condition-list clearfix">
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">农场热卖</a>
								</li>
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">主题农庄</a>
								</li>
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">特色生态游</a>
								</li>
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">特色农家乐</a>
								</li>
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">养殖场</a>
								</li>
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">家乡味主题馆</a>
								</li>
								<li class="condition-list-cell">
									<a class="condition-btn-link" href="">主题攻略</a>
								</li>
