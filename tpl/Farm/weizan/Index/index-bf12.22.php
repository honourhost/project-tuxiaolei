			...
			<div id="search" class="search active-place">
							...
							<div class="place place_search_box">
								<div class="input-control">
									<form class="place_search_form" target="_blank" action="" method="post">
										<input class="txt placesearch_txt" type="text" placeholder="青岛" autofocus autocomplete="off">
				...
				<div class="q-layer q-layer-placesearch-history">
					...
					<div class="placesearch-history-cont hot">
						<a href="/index.php?g=Group&c=Search&a=index&w=青岛" target="_blank">青岛</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=杭州" target="_blank">杭州</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=上海" target="_blank">上海</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=北京" target="_blank">北京</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=天津" target="_blank">天津</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=天水" target="_blank">天水</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=潍坊" target="_blank">潍坊</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=西安" target="_blank">西安</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=定西" target="_blank">定西</a>
					</div>
				</div>
				<div class="q-layer q-layer-zsearch-history">
					...
					<div class="zsearch-history-cont hot">
						<a href="/index.php?g=Group&c=Search&a=index&w=北海湾海参" target="_blank">北海湾海参</a>
						<a href="/index.php?g=Group&c=Search&a=index&w=北海湾海参" target="_blank">北海湾海参</a>
					</div>
				</div>
			</div>
