    ...
    <div class="hot cf">
        <div class="loginbar cf">
			...
			<div class="weixin cf">
				...
				<div class="weixin_icon"><p><a href="{pigcms{$config.site_url}/topic/weixin.html" target="_blank">访问微信版</a></p><img src="{pigcms{$config.wechat_qrcode}"/></div>
			</div>
        </div>
        <div class="list">
			<ul class="cf">
...
<header class="header cf">
    ...
    <div class="nav cf">
		...
		<div class="menu">
			<div class="ment_left">
			  <div class="ment_left_img"><img src="/liuchang/images/hear/so_left_1.png" /></div>
			  <div class="ment_left_txt">过期退</div>
			</div>
			<div class="ment_left">
			  <div class="ment_left_img"><img src="/liuchang/images/hear/so_left_2.png" /></div>
			  <div class="ment_left_txt">赢免单</div>
			</div>
			<div class="ment_left">
			  <div class="ment_left_img"><img src="/liuchang/images/hear/so_left_3.png" /></div>
			  <div class="ment_left_txt">极速达</div>
			</div>
		</div>
    </div>
</header>