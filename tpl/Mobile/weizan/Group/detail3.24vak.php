					...
					<div class="order-footer-left">
						<p style="color: #fff;">
							<a class="phone-group-xq-footer-add" style="cursor:pointer;" onclick="addCollect({pigcms{$now_group.group_id});">
								...
								<img src="{pigcms{$static_path}images/xnd_img/iconfont-shoucangyishoucang.png" height="22px" style="margin-top: 5px;" />
								<span id="collect">已收藏</span>
								<else/>
								<img src="{pigcms{$static_path}images/xnd_img/iconfont-guanzhu.png" height="20px" style="margin-top: 7px;" />
