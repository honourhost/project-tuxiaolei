	...
	<head>
		...
		<body>
			...
			<div class="public_cen">
				<div class="phone-xq" style="background-image: url({pigcms{$now_group.pic.0.s_image});"></div>
				<div class="phone-xq-title">
					<h3>{pigcms{$now_group.name}</h3>
				...
				<div class="phone-xq-shop">
					<div class="phone-xq-shop-cen">
						...
						<div class="phone-xq-shop-get">
							<a href="{pigcms{:U('Merchant/detail',array('mer_id'=>$now_group['mer_id'],'lat'=>$_GET['lat'],'long'=>$_GET['long']))}">进店看看</a>
						</div>
				...
				<div class="phone-xq-footer">
					<a class="phone-xq-footer-car" href="">
						<img src="{pigcms{$static_path}images/xnd_img/iconfont-car.png">
						<span>0</span>
					</a>
					<a class="phone-xq-footer-add">
						加入购物车
					</a>
					<a class="phone-xq-footer-buy" href="#">
						立即购买
					</a>
				</div>
			</div>
		...
		<script>
			var i=0;
			$('.phone-xq-footer-add').click(function(){
				i+=1;
				$(".phone-xq-footer-car span").html(i);
			});
		</script>
</html>