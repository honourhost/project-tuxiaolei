	...
	<body class="phone-order-body">
		<div class="phone-order public_cen">
			...
			<ul class="phone-order-ul">
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="7">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);">
				...
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="6">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);">
				...
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="5">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);">
				...
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="4">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);"></div>
						<div class="order-right-title">
							<h3 class="order-h3">
								商品名称商品名称商品名称商品名称商品名称商品名称商品名称商品名称
							</h3>
				...
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="3">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);">
				...
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="1">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);">
				...
				<li>
					<input type="checkbox" class="checkbox" name="chk_list" value="2">
					<div class="phone-order-right">
						<div class="order-right-shop" style="background-image: url({pigcms{$static_path}images/xnd_img/275x185.jpg);">
			...
			<form id="myform" method="post" action="{pigcms{:U('Group/saveorder')}">
			<div style="width: 100%; height: 60px;"></div>
			<div class="phone-order-footer">
				<div class="order-footer-left">
					<input type="hidden" name="send" id="send">
					<h3>合计：<b>&yen;<span id="total">0</span></b></h3>
					<h4>总额：&yen;<span id="money">0</span></h4>
				</div>
