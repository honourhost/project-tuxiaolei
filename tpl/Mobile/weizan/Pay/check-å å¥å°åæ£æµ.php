		...
		<div class="public_cen">
			<div class="phone-car-header">
				...
				<div class="phone-car-header-cen">
					<span class="phone-car-header-rg"><a href="{pigcms{:U('User/adress',array('order_id'=>$_GET['order_id'],'type'=>$_GET['type']))}"><img src="{pigcms{$static_path}images/xnd_img/phone-car-header-more.jpg"></a></span>
				...
				<else/>
				<div class="phone-car-header-cen">
					<a href="{pigcms{:U('User/adress',$_GET)}">添加新地址</a>
				</div>
				</if>
				<span class="phone-car-header-bg">
					<img src="{pigcms{$static_path}images/xnd_img/phone-price-header.jpg">
