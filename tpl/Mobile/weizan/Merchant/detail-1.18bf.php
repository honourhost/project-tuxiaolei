...
<html>
	...
	<body class="xnd-phone-bg" style="background: #fff;">
		...
		<div class="xnd-phone-center">
			<!-- 农场大图 -->
			<div class="xnd-phont-header-img" style="background-image: url({pigcms{$merchant.merchant_theme_image});"></div>
			...
			<div class="phone-fram-shop">
				...
				<a class="phone-fram-sc">
					<img src="{pigcms{$static_path}images/xnd_img/iconfont-shoucang.png">收藏
				</a>
