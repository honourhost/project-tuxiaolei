...
<html>
	<head>
		<meta charset="utf-8">
		<title>{pigcms{$merchant.name}</title>
	...
	<body style="background: #f4f4f4;">
		...
		function getDetail(){
			var msg='{ "url":"{pigcms{$config.site_url}/wap.php?g=Wap&c=Index&a=index&token={pigcms{$merchant.mer_id}","image_url":"{pigcms{$merchant.person_image}","title": "{pigcms{$merchant.name}", "content": "{pigcms{$merchant.txt_info}" }';
			return msg;
		}
