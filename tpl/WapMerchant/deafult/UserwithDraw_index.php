...
<div class="cen-main">
    <div class="lq-main">
        ...
        <div class="lq-font">
            <h3>我的余额</h3>
            <span>&yen;{pigcms{$moneynow}</span>
        </div>
        <if condition="$cashing eq 1">
            <a class="tx-btn" style="background: #a2a1a1;">提现中</a>
            <else />
            <a class="tx-btn" href="{pigcms{:U('UserwithDraw/withdraw')}">提现</a>
        </if>
        <p class="mingxi" style="display: none;"><a href="{pigcms{:U('UserwithDraw/detail')}">提现明细</a><img src="{pigcms{$static_path}images/icon-right.jpg" /></p>
        <div class="fuwu">
            本服务由小农丁提供
        </div>
    </div>
