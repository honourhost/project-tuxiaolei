        ...
        <div class="tixian">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="real_name" placeholder="银行卡姓名" onfocus="this.placeholder=''" onblur="this.placeholder='银行卡姓名'" />

                    </li>

                    <li>
                        <label><img src="{pigcms{$static_path}images/kaihuihang.png"></label>
                        <input type="text" name="bank_name" placeholder="开户行(如：中国农业银行青岛崂山秦岭路支行)" onfocus="this.placeholder=''" onblur="this.placeholder='开户行(如：中国农业银行青岛崂山秦岭路支行)'"   />
                    ...
                    <li>
                        <label><img src="{pigcms{$static_path}images/tixianjine.png"></label>
