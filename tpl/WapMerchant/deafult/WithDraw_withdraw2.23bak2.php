	  ...
	  <if condition="$merchant_card">
        <ul>
            ...
            <li>
                ...
                <input type="text" name="cash_num" onfocus="this.placeholder=''" placeholder="最低提现金额为50元"/>
		 ...
		 <else />
		  <ul>
            <li>
                <label><img src="{pigcms{$static_path}images/zhanghao.png" /></label>
                <input type="text" name="merchant_real_name" onfocus="this.placeholder=''" placeholder="请正确填写真实姓名" />
                
            </li>
            <li>
                <label><img src="{pigcms{$static_path}images/dianhua.png" /></label>
                <input type="text" name="merchant_real_telephone" onfocus="this.placeholder=''" placeholder="请正确填写电话信息" />
                
            </li>
            <li>
                <label><img src="{pigcms{$static_path}images/ynhang.png"></label>
                <input type="text" name="bank_name" onfocus="this.placeholder=''" placeholder="请务必正确填写银行信息" />
              
            </li>
            <li>
                <label><img src="{pigcms{$static_path}images/ynhang.png"></label>
                <input type="text"  name="bank_card" onfocus="this.placeholder=''" placeholder="请务必正确填写银行卡号信息" />
