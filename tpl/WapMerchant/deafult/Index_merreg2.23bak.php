...
<!--头部结束-->
<body>
	<header class="pigcms-header mm-slideout" style="display: none;">
	...
	<div class="container container-fill" style='padding: 10px 0;'>
	...
	<style>
		...
		.form_tips{color:red;}
		#choose_area{width: 35%;}
		#choose_circle{width: 45%;}
	</style>
	<form class="pigcms-form" method="post" action="" onsubmit="return checkSubmit();return false;">
		<div class="pigcms-container">
			<p class='pigcms-form-title'><img style="height: 15px; position: relative; top: 3px; left: 1px;" src="http://www.xiaonongding.com/tpl/WapMerchant/deafult/static/css/img/zhanghao.png"></p>
			<input type="text" class="pigcms-input-block" name="account" placeholder="请填写您的登陆账号">
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'><img src="http://www.xiaonongding.com/tpl/WapMerchant/deafult/static/css/img/mima.png"></p>
			<input type="password" class="pigcms-input-block" name="pwd" placeholder="请设置您的密码">
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'><img src="http://www.xiaonongding.com/tpl/WapMerchant/deafult/static/css/img/mingcheng.png"></p>
			<input type="text" class="pigcms-input-block" name="mername" placeholder="请填写商家名称">
		</div>
		<div class="pigcms-container">
			
			<div id="choose_cityarea" style="margin-bottom: 12px;"></div>
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'><img src="http://www.xiaonongding.com/tpl/WapMerchant/deafult/static/css/img/youxiang.png"></p>
			<input type="text" class="pigcms-input-block" name="email" placeholder="请填写您的邮箱">
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'><img src="http://www.xiaonongding.com/tpl/WapMerchant/deafult/static/css/img/dianhua.png"></p>
			<input type="text" class="pigcms-input-block" name="phone" placeholder="请填写您的联系方式">
		</div>
	  <div class="pigcms-container">
		...
		<if condition="$config['site_phone']"><p>客服电话 ：<a href="tel:{pigcms{$config.site_phone}">4006-657-170</a></p></if>
	</div>
	</div>
