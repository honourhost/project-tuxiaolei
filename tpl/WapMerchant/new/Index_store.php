...
<body>
	...
	<form class="pigcms-form" method="post" action="" onsubmit="return checkSubmit();">
		...
		<div class="pigcms-container">
			...
			<input type="tel" class="pigcms-input-block" name="weixin" placeholder="请输入店铺联系微信" value="{pigcms{$store['weixin']}" >
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'>联系Q Q</p>
			<input type="tel" class="pigcms-input-block" name="qq" placeholder="请输入店铺联系QQ" value="{pigcms{$store['qq']}" >
		</div>
		<div class="pigcms-container">
			<p class='pigcms-form-title'> 关键词</p>
			<input type="tel" class="pigcms-input-block" name="keywords" placeholder="请输入关键词" value="{pigcms{$store['keywords']}" >
		</div>
		<div class="pigcms-container">
		...
		<div class="pigcms-container">
			...
			<input type="tel" class="pigcms-input-block" name="feature" placeholder="请输入店铺特色" value="{pigcms{$store['feature']}" >
		</div>
		<div class="pigcms-container">
