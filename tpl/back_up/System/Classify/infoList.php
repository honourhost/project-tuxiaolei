			...
			<table class="search_table" width="100%">
				<tr>
					<td>
						...
						<span>ID：
						<input type="text" value="{pigcms{$id}" name="id" style="height: 22px;width: 70px;"></input>
						</span>&nbsp;&nbsp;&nbsp;
						<span>
						标题：
						<input type="text" value="{pigcms{$title}" name="title" style="height: 22px;width: 250px;"></input>
						</span>&nbsp;&nbsp;&nbsp;
							分类列表：
