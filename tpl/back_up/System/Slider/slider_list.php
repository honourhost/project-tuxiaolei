		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					...
					<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Slider/slider_add',array('cat_id'=>$now_category['cat_id']))}','添加导航',480,240,true,false,false,addbtn,'add',true);">添加导航</a>
				</ul>
			</div>
