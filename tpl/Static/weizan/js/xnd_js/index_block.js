...
function(t, e, n, i) {
	...
	require(["web_qui_quiautocomplete"], function(t) {
		...
		function n() {
			var t = [];
			return t.push('<li><a href="/index.php?g=Group&c=Search&a=index&w=农家宴" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">农家宴</span></a></li>'), t.push('<li><a href="/index.php?g=Group&c=Search&a=index&w=生态农场" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">生态农场</span></a></li>'), t.push('<li><a href="/index.php?g=Group&c=Search&a=index&w=养殖场" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">养殖场</span></a></li>'), t.push('<li><a href="/index.php?g=Group&c=Search&a=index&w=有机蔬菜" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">有机蔬菜</span></a></li>'), t.push('<li><a href="/index.php?g=Group&c=Search&a=index&w=羊肉" data-bn-ipg="zsj-search-hot"><em>热门搜索</em><span class="name">羊肉</span></a></li>'),  t
		}

		function i() {
			for (var t = [], e = a(), n = "", i = "", o = 0; o < e.length && (n = e[o].val, i = "" === e[o].url ? "/index.php?g=Group&c=Search&a=index&w=" + encodeURIComponent(n) : e[o].url, t.push('<li><a href="' + i + '" data-bn-ipg="zsj-search-history"><em>历史记录</em><span class="zwui-iconfont icon-clock"></span><span class="name">' + n + "</span></a></li>"), 2 != o); o++);
			return t
		}
		...
		new t({
			...
			width: "440",
			zindex: 99,
			dataSource: "/index.php?g=Group&c=Search&a=index&w=",
			submitOnEnter: !1,
			defalutHTML: r,
