			...
			$.each(result.list,function(i,item){
				...
				if(item.pics){
					...
					$.each(item.pics,function(j,jtem){
						item_html+= '<li m-src="'+jtem.image+'" big-src="'+jtem.image+'"><a class="pic-thumbnail" href="javascript:void(0);"  onclick="showPic(this);" hidefocus="true"><img src="'+jtem.image+'"></a></li>';
					});
