		...
		<div class="zw-home-firstfocus">
			...
			<div class="zw-home-sliders" id="homeSliders">
				<ul class="zw-home-sliders-list">
					...
					<li style="background-image:url({pigcms{$static_path}images/xnd_img/hd_04.jpg)">
						<a href="" target="_blank"></a>
					</li>
					<li style="background-image:url({pigcms{$static_path}images/xnd_img/hd_05.jpg)">
						<a href="" target="_blank"></a>
					</li>
				</ul>
				...
				<div class="zw-home-category-contents" id="zwCategoryContents">
					...
					<div class="zw-home-category-content">
						...
						<div class="column">
							...
							<div class="zw-home-category-place">
								...
								<ul class="list">
									<li><a href="" target="_blank">日本专场——东瀛印象</a></li>
								</ul>
							</div>
					...
					<div class="zw-home-category-content">
						...
						<div class="column">
							...
							<p class="zw-home-category-ztpic">
								<a href="" target="_blank">
									<img src="{pigcms{$static_path}images/xnd_img/taiguo.jpg" width="100%">
								</a>
							</p>
						</div>
					</div>
			...
			<div class="zw-home-wanle-wrap">
				...
				<div class="zw-home-wanle-content">
					<ul class="zw-home-wanle-list clearfix">
						<if condition="$farm_cat1_list">
						<volist name="farm_cat1_list" id="farm" key="k">
							<if condition="$k==1">
								<li class="zw-home-wanle-one">
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="{pigcms{$farm.merchant_theme_image}" src="{pigcms{$farm.merchant_theme_image}" width="auto" height="265" style="position:relative; left:-14px;">
								</p>
								<div class="mask"></div>
								<h3 class="title">{pigcms{$farm.name}</h3>
								<div class="infos clearfix">
									<p class="type"><php>echo mb_substr($farm['txt_info'],0,20,"utf-8")."...";</php></p>
									<p class="price"><em><php>echo getAreaName($farm['area_id']);</php></em></p>
								</div>
							</a>
						</li>
						<!-- 如果数目等于1，也输出查看热门农场-->
								<if condition="count($farm_cat1_list) eq 1">
									<li class="zw-home-channel-more zw-home-wanle-more">
							<div class="titles">
								<a href="/farm/index.html" target="_blank" >
									<p class="title">查看更多<br>热门农场</p>
									<p class="arrow">
										<span class="zwui-iconfont icon-more"></span>
									</p>
								</a>
						...
						<li class="zw-home-wanle-item">
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="{pigcms{$farm.merchant_theme_image}" src="{pigcms{$farm.merchant_theme_image}" width="120" height="120">
								</p>
								<h3 class="title">{pigcms{$farm.name}</h3>
								<p class="ico"><php>echo mb_substr($farm['txt_info'],0,20,"utf-8")."...";</php></p>
								<em class="price"><php>echo getAreaName($farm['area_id']);</php></em>
							</a>
						</li>
								<elseif condition="$k==2"/>
								<li class="zw-home-wanle-item">
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								...
								<!-- 如果数目小于4，也输出查看热门农场-->
								<if condition="count($farm_cat1_list) lt 4">
									<li class="zw-home-channel-more zw-home-wanle-more">
								<div class="titles">
								<a href="/farm/index.html" target="_blank" >
									<p class="title">查看更多<br>热门农场</p>
						...
						<else/>
						<li class="zw-home-wanle-item">
							<h3 class="title">暂时还没有此类的推荐农场，敬请期待。。。</h3>
						</li>
						<li class="zw-home-channel-more zw-home-wanle-more">
							<div class="titles">
								<a href="/farm/index.html" target="_blank" >
					...
					<ul class="zw-home-wanle-list clearfix" style="display:none;">
						<if condition="$farm_cat2_list">
						<volist name="farm_cat2_list" id="farm" key="k">
							<if condition="$k==1">
								<li class="zw-home-wanle-one">
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								<p class="pics">
						...
						<!-- 如果数目等于1，也输出查看热门农场-->
								<if condition="count($farm_cat2_list) eq 1">
									<li class="zw-home-channel-more zw-home-wanle-more">
							<div class="titles">
								<a href="/farm/index.html" target="_blank" >
									<p class="title">查看更多<br>热门农场</p>
						...
						<elseif condition="$k==2"/>
							...
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								...
								<!-- 如果数目小于4，也输出查看热门农场-->
								<if condition="count($farm_cat2_list) lt 4">
									<li class="zw-home-channel-more zw-home-wanle-more">
								<div class="titles">
								<a href="/farm/index.html" target="_blank" >
									<p class="title">查看更多<br>热门农场</p>
					...
					<ul class="zw-home-wanle-list clearfix" style="display:none;">
						<if condition="$farm_cat3_list">
						<volist name="farm_cat3_list" id="farm" key="k">
							<if condition="$k==1">
								<li class="zw-home-wanle-one">
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								<p class="pics">
						...
						<!-- 如果数目等于1，也输出查看热门农场-->
								<if condition="count($farm_cat3_list) eq 1">
									<li class="zw-home-channel-more zw-home-wanle-more">
							<div class="titles">
								<a href="/farm/index.html" target="_blank" >
									<p class="title">查看更多<br>热门农场</p>
						...
						<elseif condition="$k==2"/>
							...
							<a href="/merindex/{pigcms{$farm.mer_id}.html" target="_blank">
								...
								<!-- 如果数目小于4，也输出查看热门农场-->
								<if condition="count($farm_cat3_list) lt 4">
									<li class="zw-home-channel-more zw-home-wanle-more">
								<div class="titles">
								<a href="/farm/index.html" target="_blank" >
									<p class="title">查看更多<br>热门农场</p>
		...
		<div class="zw-home-zhuanti">
			<div class="zw-home-zhuanti-wrap">
				...
				<div class="zw-home-zhuanti-content">
					<volist name="activity_lists" id="activities" key="k"> 
						<if condition="$k==1">
						<ul class="zw-home-zhuanti-list clearfix">
							<volist name="activities" id="activity" key="m">
								<if condition="$m==1">
						<li class="zw-home-zhuanti-one">
							<a href="/activity/{pigcms{$activity.pigcms_id}.html" target="_blank" >
								<p class="pics">
									<img class="lazy" data-original="{pigcms{$activity.list_pic}" src="{pigcms{$activity.list_pic}" width="570" height="auto" style="position:relative; top:-56px;">
								</p>
								<div class="mask"></div>
								<div class="mask2"></div>
								<div class="tag">{pigcms{$activity.name}</div>
								<h3 class="title"> {pigcms{$activity.title}</h3>
								<p class="price"><em>{pigcms{$activity.price}</em>元起</p>
							</a>
						</li>
						<else/>
						<li class="zw-home-zhuanti-item">
							<a href="/activity/{pigcms{$activity.pigcms_id}.html" target="_blank">
								<p class="pics">
									<img class="lazy" data-original="{pigcms{$activity.list_pic}" src="{pigcms{$activity.list_pic}" width="275" height="auto" style="position:relative; top:-12px;">
								</p>
								<div class="infos">
									<h3 class="title"> {pigcms{$activity.title}</h3>
									<p class="price"><em>{pigcms{$activity.price}</em>元起</p>
					...
					<li class="zw-home-channel-more zw-home-zhuanti-more">
						...
						<ul class="zw-home-zhuanti-list clearfix" style="display:none;">
							<volist name="activities" id="activity" key="n">
							<if condition="$n==1">
						<li class="zw-home-zhuanti-one">
							<a href="/activity/{pigcms{$activity.pigcms_id}.html" target="_blank" >
								<p class="pics">
