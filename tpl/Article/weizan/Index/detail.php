...
<html >
	<head>
		...
		<title>{pigcms{$article.title} | 农丁头条</title>
		<meta name="keywords" content="{pigcms{$config.seo_keywords}" />
		<meta name="description" content="{pigcms{$article.digest}" />

		<link href="/upload/icon/icon.jpg" rel="SHORTCUT ICON" />
		<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/xnd_css/frame.css"/>
		<link href="{pigcms{$static_path}css/css.css" type="text/css"  rel="stylesheet" />
		<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/xnd_css/detail.css"/>
...
window._bd_share_config={"common":{onBeforeClick: SetShareUrl,"bdSnsKey":{},"bdText":"","bdMini":"1","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"32"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
					...
					<div class="content-tm">
						<i class="inbg2 zhhf2"></i>&nbsp;来源：<b>{pigcms{$article.author}</b>
						<i class="inbg3 zhhf2"></i>
						<h3>发布时间：<php>echo date("Y-m-d H:m:s",$article['dateline']);</php></h3>
						<i class="inbg4 zhhf2" style="margin-left: 40px;"></i>&nbsp;阅读量：<?php echo $article["count"]*21;?>人阅读过
...
.nc-main .nc-logo img{
    ...
    if (is_mobile()) {
        document.location.href = 'http://www.tuxiaolei.cn/wap.php?g=Wap&c=Article&a=index&imid={pigcms{$article.pigcms_id}';
    }
</script>
