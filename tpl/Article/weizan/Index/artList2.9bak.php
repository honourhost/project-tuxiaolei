													...
													<dl class="con-detail">
														<dd class="xcfb">
															<div class="tle-con">
																...
																<i class="inbg zhhf"></i>
																发布时间
																<b class="xnum"><php>echo date("Y-m-d H:m:s",$text['dateline']);</php></b>由<a href="{pigcms{$config.site_url}/merindex/{pigcms{$text.mer_id}.html" target="_blank">{pigcms{$text.name}</a>发布
															</span>
