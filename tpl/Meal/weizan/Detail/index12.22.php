...
<include file="Public:header_top"/>
	...
	<div class="w-1200">
		<div class="grid_subHead clearfix">
			<div class="col_main">
				<div class="col_sub">
					<div class="shop_logo" style="background-image: url({pigcms{$store['images'][0]});"></div>
				</div>
				<div class="main_wrap cf">
					<p></p>
					<div class="main_wrap_right">
						<ul class="songcan_data clearfix">
							<li><span>送达时间 <b>{pigcms{$store['send_time']}分钟</b></span></li>
							<li class="renjun"><span>起送价格 <b>{pigcms{$store['basic_price']}元</b></span></li>
							<li class="peison"><span>配送费用 <b>{pigcms{$store['delivery_fee']}元</b></span></li>
						</ul>
					</div>
...
<div class="body"> 
	...
	<div class="tab1" id="tab1">
		<div class="sh_menu" style="color: #4c4c4c;">
			<ul>
				<li id="one1" onclick="setTab('one',1)" class="off">小店商品</li>
				<li id="one2" onclick="setTab('one',2)">网友点评</li>
				<li><a href="{pigcms{$config.site_url}/merindex/{pigcms{$store.mer_id}.html" target="_blank">农场主页</a></li>
			</ul>
		</div>
		<div class="menudiv">
			<div id="con_one_1">
