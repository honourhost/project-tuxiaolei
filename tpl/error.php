	...
	<body id="body">
		...
		<div class="max-width" style="background:#fff;font-size:14px;max-width:600px; min-width: 240px; margin:60px auto; line-height:48px;height:28px;text-align:center;padding:60px 30px 100px 30px;border:5px solid #f3f3f3">
			<present name="message">
				<img src="{pigcms{$config.site_url}/static/js/artdialog/skins/icons/face-smile.png" align="absmiddle" />
				&nbsp;&nbsp;<?php echo($message); ?>
					<else/>
					<img src="{pigcms{$config.site_url}/static/js/artdialog/skins/icons/face-sad.png" align="absmiddle" />
					&nbsp;&nbsp;<?php echo($error); ?>
		...
		<div class="public-cen">
			...
			<h3 class="title"><?php echo($error); ?></h3>
			</present>
