<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Adver/adver_amend')}" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">广告描述</th>
				<td><input type="text" class="input fl" name="desc" id="desc" style="width:200px;" validate="required:true" value="{pigcms{$now_adver.desc}" placeholder="需要填写" tips="广告描述"/></td>
			</tr>
			<tr>
				<th width="80">链接地址</th>
				<td>
			...
			<tr>
				<th width="80">显示排序</th>
				<td><input type="text" class="input fl" name="sort" id="sort" style="width:100px;" validate="required:true" value="{pigcms{$now_adver.sort}"  placeholder="需要填写" tips="显示排序,（越大越靠前）"/></td>
			</tr>
			<tr>
				<th width="80">广告状态</th>
				<td>
