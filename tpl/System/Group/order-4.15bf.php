		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					...
					<a href="{pigcms{:U('Group/order')}">订单列表</a>
					<a href="{pigcms{:U('Group/order',array('searchtype'=>'unsend'))}"  class="on">商家未处理订单列表</a>
					<else/>
					<a href="{pigcms{:U('Group/order')}" class="on">订单列表</a>
					<a href="{pigcms{:U('Group/order',array('searchtype'=>'unsend'))}" >商家未处理订单列表</a>
					</if>
				</ul>
			</div>
