<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Group/cat_amend')}" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
            ...
            <tr>
                <th width="80">一句话描述分类</th>
                <td><input type="text" class="input fl" name="cat_desc" id="cat_desc" value="{pigcms{$now_category.cat_desc}" size="25" placeholder="分类描述" validate="maxlength:20,required:true" tips="不超过20个字"/></td>
            </tr>
				...
				<tr>
					...
					<td><input type="file" class="input fl" name="cat_pic" style="width:200px;"  value="required:true"  placeholder="分类LOGO图片"  tips="分类LOGO小图标，建议尺寸100*100"/></td>
				</tr>
            ...
            <tr>
                ...
                <td><input type="text" class="input fl" name="cat_group_id" value="{pigcms{$now_category.cat_group_id}" size="10" placeholder="特卖id" validate="maxlength:6,required:true,number:true" /></td>
            </tr>
			<tr>
				<th width="80">是否热门</th>
				<td>
