			...
			<div id="nav" class="mainnav_title">
				<ul>
					<if condition="empty($now_category)">
						<a href="{pigcms{:U('Group/index')}" class="on">分类列表</a>|
						<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Group/cat_add',array('cat_fid'=>intval($_GET['cat_fid'])))}','添加主分类',480,260,true,false,false,addbtn,'add',true);">添加主分类</a>
					<else/>
						<a href="{pigcms{:U('Group/index')}">分类列表</a>|
						<a href="{pigcms{:U('Group/index',array('cat_fid'=>$_GET['cat_fid']))}" class="on">{pigcms{$now_category.cat_name} - 子分类列表</a>|
							...
							<if condition="is_array($category_list)">
								<volist name="category_list" id="vo">
									<tr>
										...
										<if condition="empty($_GET['cat_fid'])">
											<td><a href="{pigcms{:U('Group/index',array('cat_fid'=>$vo['cat_id']))}">查看子分类</a></td>
										...
										<td class="textcenter"><a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Group/cat_edit',array('cat_id'=>$vo['cat_id'],'frame_show'=>true))}','查看分类信息',480,260,true,false,false,false,'detail',true);">查看</a> | <a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Group/cat_edit',array('cat_id'=>$vo['cat_id']))}','编辑分类信息',480,<if condition="$vo['cat_fid']">240<else/>340</if>,true,false,false,editbtn,'edit',true);">编辑</a> | <a href="javascript:void(0);" class="delete_row" parameter="cat_id={pigcms{$vo.cat_id}" url="{pigcms{:U('Group/cat_del')}">删除</a></td>
									</tr>
								</volist>
