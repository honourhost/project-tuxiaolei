<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Slider/slider_amend')}" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">是否在APP加载网页</th>
				<td><input type="text" class="input fl" name="flag" style="width:80px;" value="{pigcms{$now_slider.flag}" validate="maxlength:10,required:true,number:true"/></td>
			</tr>
			<tr>
				<th width="80">导航状态</th>
				<td>
