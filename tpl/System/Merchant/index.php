							...
							<if condition="is_array($merchant_list)">
								<volist name="merchant_list" id="vo">
									<tr>
										...
										<if condition="$vo['menus']">
										<td >{pigcms{$vo.account}</td>
										<td >{pigcms{$vo.name}</td>
										<else/>
										<td style="color:red;">{pigcms{$vo.account}</td>
										<td style="color:red;">{pigcms{$vo.name}(未进行实名认证商户)</td>
										</if>
										...
										<td class="textcenter"><a href="{pigcms{:U('Merchant/cash_info',array('mer_id'=>$vo['mer_id']))}">查看提现记录</a></td>
										<td class="textcenter"><a href="{pigcms{:U('Merchant/order',array('mer_id'=>$vo['mer_id']))}">查看账单</a>|<a href="{pigcms{:U('Merchant/fastorder',array('mer_id'=>$vo['mer_id']))}">查看快捷付款账单</a></td>
