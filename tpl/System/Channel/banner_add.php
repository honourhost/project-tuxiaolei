<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Channel/banner_modify')}" enctype="multipart/form-data">
		<input type="hidden" name="c_id" value="{pigcms{$now_category.id}"/>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">图片</th>
				<td><input type="file" class="input fl" name="pic" style="width:180px;" placeholder="请上传图片" tips="可不上传"/><span style="color:red;">上传大小限制：750*300</span></td>
			</tr>
			<tr>
				<th width="80">链接地址</th>
				<td>
				<input type="text" class="input fl" name="url" id="url" style="width:180px;" placeholder="请填写链接地址" validate="maxlength:200,url:true"/>
