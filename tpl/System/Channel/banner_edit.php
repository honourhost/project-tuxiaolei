<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Channel/banner_amend')}" enctype="multipart/form-data">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<if condition="$now_slider['pic']">
				<tr>
					<th width="80">现图</th>
					<td><img src="{pigcms{$config.site_url}/upload/channelbanner/{pigcms{$now_slider.pic}" style="width:80px;height:80px;" class="view_msg"/></td>
				</tr>
			</if>
			<tr>
				<th width="80">图片</th>
			...
			<tr>
				<th width="80">链接地址</th>
				<td>
				<input type="text" class="input fl" name="url" id="url" value="{pigcms{$now_slider.url}" style="width:200px;" placeholder="请填写链接地址" validate="maxlength:200,url:true"/>
