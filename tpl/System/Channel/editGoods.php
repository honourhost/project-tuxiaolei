...
<div class="mainbox">
    ...
    <form id="myform" method="post" action="{pigcms{:U('Channel/editGoods')}" frame="true" refresh="true">
        <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
            ...
            <tr>
                <th width="80">商品id</th>
                <td><input type="text" class="input fl" id="goods_id" name="goods_id" size="25" placeholder="商品id" validate="maxlength:40,required:true" tips="商品id！，必填！" value="{pigcms{$goods.goods_id}"/></td>
            </tr>
        </table>
        <div class="btn">
