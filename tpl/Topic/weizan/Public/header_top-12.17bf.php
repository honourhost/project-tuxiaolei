			...
			<div class="header-inner">
				...
				<div class="nav">
					<ul class="nav-ul">
							<li class="nav-list nav-list-layer index_over">
								<span class="nav-span" onclick="window.location.href='{pigcms{$config.site_url}?area=all'" style="cursor:pointer;">
								当前地区：全国<i class="iconfont icon-jiantouxia"></i>
							</span>
							...
							<li class="nav-list ">
								<a class="nav-span" href="" title="">农特超市</a>
							</li>
				...
				<div class="fun">
					<div id="siteSearch" class="nav-search">
						<form action="{pigcms{:U('Group/Search/index')}" group_action="{pigcms{:U('Group/Search/index')}" meal_action="{pigcms{:U('Meal/Search/index')}" method="get">
					...
					<div class="nav-list nav-list-layer">
							<span class="nav-span" style=" padding: 0px 10px; margin-right: 0;">
					...
					<div class="nav-list nav-list-layer">
							<span class="nav-span" style=" padding: 0px 0px; margin-right: 0;">
				...
				<div class="zw-header-searchs" id="zwheadSearchs">
					<form action="{pigcms{:U('Group/Search/index')}" method="post" group_action="{pigcms{:U('Group/Search/index')}" meal_action="{pigcms{:U('Meal/Search/index')}">
						<div class="ipts">
							...
							<input type="text" name="w" value="" placeholder="搜索国家、城市、产品" autocomplete="off" class="iptext" id="zwheadSearchText">
						</div>
					<form>
				</div>
			</div>
