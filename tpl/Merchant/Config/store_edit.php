						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="unit">农场主头像</label></label>
									...
									<span class="form_tips" style="color:red;">必填。（图片文件大小不能超过{pigcms{$config.meal_pic_size}M,建议上传大尺寸的图片。） 图片宽度建议为195px，高度建议为146px</span>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="name">农场名称</label></label>
									<input class="col-sm-2" size="20" name="name" id="name" value="{pigcms{$now_store.name}" type="text"/>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="phone">农场主名称</label></label>
									<input class="col-sm-2" size="20" name="phone" value="" type="text"/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="feature">农场简介</label></label>
								...
								<div class="form-group"><label class="col-sm-1">是否设置成主店</label><label><input type="radio" name="ismain" value="1" <if condition="$now_store['ismain'] eq 1">checked="checked"</if>>&nbsp;&nbsp;是</label>
								 ...
								 &nbsp;&nbsp;&nbsp;<span class="form_tips">如果将此农场设置成主店，系统将自动取消其他已设置的主店</span>
								</div>
							   ...
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<select name="store_type" id="store_type">
											<option value="0" <if condition="$now_store['store_type'] eq 0">selected="selected"</if>>农场分类</option>
											<option value="1" <if condition="$now_store['store_type'] eq 1">selected="selected"</if>>农场分类2</option>
											<option value="2" <if condition="$now_store['store_type'] eq 2">selected="selected"</if>>农场分类3</option>
									</select>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="unit">农场主题图</label></label>
									<span class="col-sm-2" style="padding-left:0px;">
										<input id="ytimage-file" type="hidden" value="" name="person_image"/>
										<input class="col-sm-1" id="image-file" size="200" onchange="previewimage(this)" name="image" type="file"/>
									</span>
