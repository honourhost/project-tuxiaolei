								...
								<if condition="$list">
									<volist name="list" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<p style="color:blue;cursor:pointer;" href="{pigcms{$config['site_url']}/wap.php?c=Article&a=index&imid={pigcms{$row['pigcms_id']}"  class="see_article_qrcode">{pigcms{$row['title']}<span style="color:gray;">(点击显示微信预览二维码)</span></p>
											</volist>
											</td>
											...
											<td class="button-column" nowrap="nowrap">
												...
												<a href="{pigcms{$config['site_url']}/wap.php?c=Article&a=index&imid={pigcms{$row['pigcms_id']}" target="_blank">预览</a>
											</td>
										</tr>
									</volist>
								<else/>
