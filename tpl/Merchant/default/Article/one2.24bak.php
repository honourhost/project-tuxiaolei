							...
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<div class="form-group">
									...
									<select name="cat_id">
										...
										<if condition="$cat['id'] eq $image_text['cat_id']">
										<option value="{pigcms{$cat.id}" selected>{pigcms{$cat.name}</option>
										<else/>
								...
								<div class="form-group">
									...
									<textarea class="col-sm-3" id="content" name="content" style="width: 600px; height: 900px; display: none;">{pigcms{$image_text['content']}</textarea>
								</div>
								...
								<div class="form-group">
									...
									<input class="col-sm-3" name="video_url" id="video_url" type="text" value="{pigcms{$image_text['video_url']}"/>请填写腾讯视频的vid</br></br>　
...
KindEditor.ready(function(K) {
	editor = K.create('#content', {
		...
		'insertunorderedlist','link', 'unlink','image','diyTool',"multiimage"]
	});
