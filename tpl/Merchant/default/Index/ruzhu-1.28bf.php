											...
											<div class="form-group">
												...
												<div id="legal_represent_cardimage_box">
													<if condition="$now_merchant['legal_represent_cardimage']">
														<img style="width:400px;height:200px" src="{pigcms{$now_merchant.legal_represent_cardimage}" alt="图片预览" title="图片预览"/>
													</if>
												</div>
											</div>
											<div class="form-group sc-zhao">
											...
											<div class="form-group">
												...
												<div id="person_cardimage_box">
													<if condition="$now_merchant['person_cardimage']">
														<img style="width:400px;height:200px" src="{pigcms{$now_merchant.person_cardimage}" alt="图片预览" title="图片预览"/>
													</if>
												</div>
											</div>
											<div class="form-group sc-zhao">
