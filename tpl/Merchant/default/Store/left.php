	...
	<ul class="nav nav-list" style="top: 0px;">
		<li class="hsub <if condition="strpos(ACTION_NAME,'group') nheq false">open active</if>">
			<a href="#" class="dropdown-toggle"> 
				...
				<span class="menu-text">特卖订单管理</span>
			...
			<ul class="submenu">
				<li <if condition="strpos(ACTION_NAME,'group') nheq false">class="active"</if>>
					<a href="{pigcms{:U('Store/group_list')}"> 
						<i class="menu-icon fa fa-caret-right"></i> 特卖订单列表
					</a>
					<b class="arrow"></b>
				</li>
				<li <if condition="strpos(ACTION_NAME,'group') nheq false">class="active"</if>>
				<a href="{pigcms{:U('Store/group_buy_list')}">
					<i class="menu-icon fa fa-caret-right"></i> 拼团订单
				</a>
				<b class="arrow"></b>
				</li>
				<li <if condition="strpos(ACTION_NAME,'group') nheq false">class="active"</if>>
				<a href="{pigcms{:U('Store/lottery_group_list')}">
					<i class="menu-icon fa fa-caret-right"></i> 抽奖团订单
				</a>
				<b class="arrow"></b>
				</li>
			</ul>
		...
		<li class="hsub <if condition="strpos(ACTION_NAME,'meal') nheq false">open active</if>">
			<a href="#" class="dropdown-toggle"> 
				...
				<span class="menu-text">农小店订单管理</span>
				<b class="arrow fa fa-angle-down"></b>
			</a>
			<b class="arrow"></b>
			<ul class="submenu">
				<li <if condition="strpos(ACTION_NAME,'meal') nheq false">class="active"</if>>
					<a href="{pigcms{:U('Store/meal_list')}">
						<i class="menu-icon fa fa-caret-right"></i> 农小店订单列表
					</a>
					<b class="arrow"></b>
				</li>					
			</ul>
		...
		<li style="display: none;" class="hsub <if condition="strpos(ACTION_NAME,'appoint') nheq false">open active</if>">
			<a href="#" class="dropdown-toggle"> 
				<i class="menu-icon fa fa-cutlery"></i>
