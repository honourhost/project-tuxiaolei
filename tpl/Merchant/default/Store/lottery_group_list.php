    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                抽奖团{pigcms{$config.group_alias_name}订单列表
            </li>
        </ul>
    </div>
    <!-- 内容头部 -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <button class="btn btn-success" onclick="CreateShop()">查找订单</button>&nbsp;
                      <a class="btn btn-success" href="{pigcms{:U('Store/lottery_group_list')}">所有订单</a>&nbsp;
                    <a class="btn btn-success" href="{pigcms{:U('Store/lottery_group_list',array('unsend'=>1))}">未发货订单</a>&nbsp;
                    <!--   <a class="btn btn-success" href="{pigcms{:U('Store/group_list',array('special'=>1))}">支付与下单时间相差超过一天的未处理订单</a>&nbsp;-->
                 
                    <a class="btn btn-success" href="{pigcms{:U('Store/lottery_group_list',array('hassend'=>1))}">已发货订单</a>&nbsp;
                    ...
                    <div id="shopList" class="grid-view">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <volist name="order_list" id="vo">
                                ...
                                <td width="200"><a href="javascript:void(0);" target="_blank">{pigcms{$vo.order_name}&nbsp;<?php echo getUserName($vo['uid']);?>开团</a></td>
                                <td width="150">
                                    数量：{pigcms{$vo.num}<br/>
...
<script>
    ...
    function CreateShop(){
        window.location.href = "{pigcms{:U('Store/lotterygroup_find')}";
    }
</script>
