										...
										<div class="grid-view">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <tr>
                                                        <td>统计总数</td>
                                                        <td>{pigcms{$StaticAll.follow_num_all}</td>
                                                        <td>{pigcms{$StaticAll.img_num_all}</td>
                                                        <td>{pigcms{$StaticAll.website_hits_all}</td>
                                                    </tr>
										...
										<div class="grid-view">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <tr>
                                                        <td>统计总数</td>
                                                        <td>{pigcms{$StaticAll.group_hits_all}</td>
                                                        <td>{pigcms{$StaticAll.group_buy_money_all}</td>
                                                        <td>￥{pigcms{$StaticAll.group_buy_count_all}</td>
                                                    </tr>
													<volist name="request_list" id="vo">
														<tr class="<if condition='$i%2 eq 0'>even<else/>odd</if>">
															<td style="width: 120px">{pigcms{$vo.time|date='Y-m-d',###}</td>
										...
										<div class="grid-view">
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <tr>
                                                        <td>统计总数</td>
                                                        <td>{pigcms{$StaticAll.meal_hits_all}</td>
                                                        <td>{pigcms{$StaticAll.meal_buy_count_all}</td>
                                                        <td>￥{pigcms{$StaticAll.meal_buy_money_all}</td>
                                                    </tr>
													<volist name="request_list" id="vo">
														<tr class="<if condition='$i%2 eq 0'>even<else/>odd</if>">
															<td style="width: 120px">{pigcms{$vo.time|date='Y-m-d',###}</td>
