...
<!--		<h3>总营收(除去平台抽成)：{pigcms{$all_total_percent}</h3><h3>总已对账(即：可直接提现金额){pigcms{$all_totalfinish_percent}</h3><a href="/store.php?g=Merchant&c=Count&a=getCash" class="btn btn-success">申请提现</a>-->
													...
													<if condition="$order_list">
														<volist name="order_list" id="vo">
															<tr>
																...
																<td style="color:red;">{pigcms{$vo.balance_pay}</td>
