                    ...
                    <div class="tab-content">
                        <div class="grid-view">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1">视频预览</label>
                                            ...
                                            <if condition="$data['video_url']">
                                                <li class="upload_pic_li">
                                                    ...
                                                    <video width="320" height="240" controls>
                                                        <source src="{pigcms{$data['video_url']}" type="video/mp4">
                                                        您的浏览器不支持Video标签。
                                                    </video>
            ...
            editor.loadPlugin('media', function () {
                editor.plugin.fileDialog({
                    ...
                    clickFn: function (url, title, width, height, border, align) {
                        ...
                        $('#upload_video_ul').html('<li class="upload_pic_li"><video width="320" height="240" controls> <source src="' + url + '"  type="video/mp4"> 您的浏览器不支持Video标签。 </video><br/><a href="#" onclick="deleteImage(\'' + title + '\',this);return false;">[ 删除 ]</a></li>');
                        $('#video_url').val(url);
