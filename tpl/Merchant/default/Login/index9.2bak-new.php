					...
					<div class="section">
						<div class="qui-login-section section-login">
							...
							<div class="qui-login-form login-form">
								...
								<div class="qui-login-input">
									<input class="text-input" type="text" id="login_verify" style="width:150px; text-indent: 10px; border: 1px solid #d7d7d7; height: 30px; position: relative; top: -10px;" maxlength="4" name="verify"/>&nbsp;&nbsp;
							...
							<div class="qui-login-form reg-form">
								...
								<div class="qui-login-input">
									<input class="text-input" type="text" id="reg_verify" style="width:150px; text-indent: 10px; border: 1px solid #d7d7d7; height: 30px; position: relative; top: -10px;" maxlength="4" name="verify"/>&nbsp;&nbsp;
									<span class="verify_box">
