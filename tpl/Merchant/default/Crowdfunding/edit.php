                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-3" maxlength="100" name="invator" type="text"
                                           value="{pigcms{$now_group.invator}"/><span
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1">众筹类别：</label>
                                      ...
                                      <if condition="$now_group.crowdcat eq 0 ">
                                          ...
                                          <elseif condition="$now_group.crowdcat eq 1 "/>
                                          <select class="col-sm-3"  name="crowdcat" type="text" >
                                              <option value="3" >
                                                  其他
                                              </option>
                                          ...
                                          <elseif condition="$now_group.crowdcat eq 2 "/>
                                          <select class="col-sm-3"  name="crowdcat" type="text" >
                                              <option value="3" >
                                                  其他
                                              </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-3" maxlength="100" type="text" name="crowdplace" value="{pigcms{$now_group.crowdplace}"/>
                            ...
                            <div id="txtimage" class="tab-pane">
                                    ...
                                    <div id="upload_pic_box">
                                        <ul id="upload_pic_ul">
                                            <li class="upload_pic_li"><img
                                                        src="{pigcms{$now_group.webpicture}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="url" value="{pigcms{$now_group.video}" name="videourl" /> <input type="button" id="insertfile" value="选择文件" />
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1">图片预览</label>
                                    <div id="upload_pic_box">
                                        <ul id="upload_pic_ulv">
                                            <li class="upload_pic_liv"><img
                                                        src="{pigcms{$now_group.videopicture}">
                                                <input type="hidden" name="videopic" value="{pigcms{$now_group.videopic}">
                                                <br>
                                                <a href="#" onclick="deletevideoImage('{pigcms{$now_group.videopic}',this);return false;">
                                                    [删除]</a></li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="upload_pic_box">
                                        <ul id="upload_pic_uli">
                                            <li class="upload_pic_lii"><img
                                                        src="{pigcms{$now_group.invatorpicture}">
                                                <input type="hidden" name="invatorpic" value="{pigcms{$now_group.invatorpic}">
                                                <br>
                                                <a href="#" onclick="deleteinvatorImage('{pigcms{$now_group.invatorpic}',this);return false;">
                                                    [删除]</a></li>
                            ...
                            <div id="crowdlevel" class="tab-pane">
                                        ...
                                        <div id="div<?php echo $k;?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <if condition="$crow.is_lottery_grade eq 1 ">
                                                    <select class="col-sm-3"  name="grade<?php echo $k;?>[]" type="text" id="grade1" >
                                                        <option value="1"selected="selected" >
                                                            否
                                                        </option>
                                                        <option value="2">
                                            ...
                                            <input class="col-sm-3" maxlength="100" name="grade<?php echo $k;?>[]" type="hidden"
                                                   id="grade1" value="{pigcms{$crow.grade_id}"/>

                                            <div class="form-group">
                                                <label class="col-sm-1">众筹多少人开一次奖：</label>
                                                <input class="col-sm-3" maxlength="100" name="grade<?php echo $k;?>[]" type="number"
                                                       id="grade1" value="{pigcms{$crow.lottery_num}"/><span
