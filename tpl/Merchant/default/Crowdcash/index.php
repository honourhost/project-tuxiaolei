            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="breadcrumbs-price">
						<span>
							<a href="{pigcms{:U('Crowdcash/getCash')}" class="btn btn-success">立即提现</a>
						</span>
                                        ...
                                        <if condition="$cash_list">
                                            <volist name="cash_list" id="vo">
                                                <tr class="odd">
                                                    ...
                                                    <td><if condition="$vo['cash_time']"><php>echo date("Y-m-d H:i:s",$vo['cash_time']);</php><else/>还没有进行处理的申请</if></td>
                                                    <td><if condition="$vo['status']==1">提现成功<elseif condition="$vo['status']==2"/>提现被驳回<else/>正在申请中</if></td>
