        ...
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{pigcms{:U('Crowdcash/getCash')}">
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    ...
                                    <span style="color:red"> &nbsp;&nbsp;请正确填写真实姓名</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span style="color:red"> &nbsp;&nbsp;请正确填写电话信息</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span style="color:red"> &nbsp;&nbsp;请务必正确填写银行以及<strong>支行</strong>信息</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span style="color:red"> &nbsp;&nbsp;请务必正确填写银行卡号信息</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span style="color:red"> &nbsp;&nbsp;最低提现金额为50元</span>
                                </div>
                            </div>
                            <div class="space"></div>
