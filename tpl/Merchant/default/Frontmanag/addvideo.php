                    ...
                    <form enctype="multipart/form-data" class="form-horizontal" method="post">
                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="cyname">视频vid（目前只限腾讯视频）</label></label>
                                    <input class="col-sm-2" size="30" name="video_url" id="cyname" value="{pigcms{$video['video_url']}" type="text" /></br></br>
                                    <br>示例：<img width="100%" height="100px;" src="./upload/merchant/no/tenvideo.jpg">
                                </div>
                                <div class="form-group">
