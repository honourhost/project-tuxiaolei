                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="20" value="http://www.xiaonongding.com/merchant.php?g=Merchant&c=weixinResponse&a=index&mer_id={pigcms{$mer_id}" name="url" type="text" readonly/>
                                </div>
                                <div class="form-group">
