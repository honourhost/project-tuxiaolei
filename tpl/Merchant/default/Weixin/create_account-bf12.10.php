                        ...
                        <div class="tab-content">
                            <div id="basicinfo" class="tab-pane active">
                                <div class="form-group">
                                    ...
                                    <input class="col-sm-2" size="20" value="http://xnd.winworlds.cn/merchant.php?g=Merchant&c=weixinResponse&a=index&mer_id={pigcms{$qrcode_url}" name="url" type="text" readonly/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1"><label for="phone">微信类型</label></label>
