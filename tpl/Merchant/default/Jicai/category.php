    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{pigcms{:U('Jicai/category')}">分类管理</a>
            </li>
                ...
                <div class="col-xs-12">
                    ...
                    <div id="shopList" class="grid-view">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <td>
                                <a class="green" style="padding-right:8px;" title="商品管理" href="{pigcms{:U('Jicai/index',array('sort_id'=>$vo['sort_id']))}">商品管理<i class="ace-icon fa fa-pencil bigger-130"></i></a>
                            </td>
                            <td>
<!--                                <a title="修改" class="green" style="padding-right:8px;" href="{pigcms{:U('Jicai/sort_edit',array('sort_id'=>$vo['sort_id']))}">-->
<!--                                    <i class="ace-icon fa fa-pencil bigger-130"></i>-->
<!--                                </a>　　-->
                                <a title="删除" class="red" style="padding-right:8px;" href="{pigcms{:U('Jicai/sort_del',array('sort_id'=>$vo['sort_id']))}">
...
<script type="text/javascript">
    ...
    function CreateShop(){
        window.location.href = "{pigcms{:U('Jicai/sort_add',array('mer_id'=>$now_store['mer_id']))}";
    }
    function updateStatus(dom1, dom2, status1, status2, attribute){
        $(dom1).each(function(){
            ...
            $.ajax({
                url:"{pigcms{:U('Jicai/sort_status')}",
                type:"post",
