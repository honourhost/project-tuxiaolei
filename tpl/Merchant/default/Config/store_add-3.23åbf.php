					...
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="edit_form">
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<input name="ismain" value="1" type="hidden">
								...
								<div class="form-group">
									...
									<fieldset id="choose_cityarea" province_id="{pigcms{$province_id}"  city_id="{pigcms{$city_id}"  area_id="{pigcms{$area_id}" circle_id=""></fieldset>
								</div>
								<div class="form-group">
								...
								<if condition="$config['store_open_meal']">
									<div class="form-group">
										...
										<select name="store_type" id="store_type">
											<option value="0" selected="selected">市区配送</option>
								...
								<div class="alert alert-info">
									...
									假设您的服务时间为晚上20:00-凌晨02:00，请填写两个时间段，第一个为“20:00-23:59”，第二个为“00:00-02:00”
								</div>
								<div class="tabbable">
									<ul class="nav nav-tabs" id="myTab">
										<li class="active">
