	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="{pigcms{:U('Config/store_edit')}">店铺管理</a>
			</li>
							...
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									...
									<span class="col-sm-2" style="padding-left:0px;">
										...
										<input class="col-sm-1" id="image-file" size="150" onchange="previewimage(this)" name="image" type="file"/>
									</span>
									<span class="form_tips" style="color:red;">必填。（图片文件大小不能超过{pigcms{$config.meal_pic_size}M,建议上传大尺寸的图片。） 图片宽度建议为150px，高度建议为150px</span>
								</div>
								<div id="image_preview_box">
									<if condition="$now_merchant['person_image']">
										<img style="width:150px;height:150px" src="{pigcms{$now_merchant.person_image}" alt="图片预览" title="图片预览"/>
										<else/>
										<img style="width:150px;height:150px" src="./upload/merchant/no/face.jpg" alt="图片预览" title="图片预览"/>
									</if>
								</div>
								<div class="form-group">
									<label class="col-sm-1">
								...
								<div class="form-group">
									<label class="col-sm-1"><b>*</b><label for="phone">农场负责人</label></label>
								...
								<div class="form-group">
									<label class="col-sm-1"><b>*</b><label for="feature">农场主承诺</label></label>
								...
								<div class="form-group">
									...
									<span class="form_tips">多个电话号码以空格分开<span style="color:red;">（必填）</span></span>
							   ...
							   <div class="form-group">
								...
								<div class="form-group">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;<a href="#modal-table" class="btn btn-sm btn-success" id="show_map_frame" data-toggle="modal">点击选取经纬度</a><span style="color:red;">（必填）</span>
								</div>
								...
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="adress" id="adress" value="{pigcms{$now_store.adress}" type="text"/><span style="color:red;">（必填）</span>
								</div>
