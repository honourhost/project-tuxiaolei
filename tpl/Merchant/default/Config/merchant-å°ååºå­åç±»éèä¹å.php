						...
						<div class="tab-content">
							...
							<div id="personal" class="tab-pane">
								<div class="form-group">
									...
									<span class="form_tips" style="color:red;">可不填。（图片文件大小不能超过{pigcms{$config.meal_pic_size}M,建议上传大尺寸的图片。） 图片宽度建议为195px，高度建议为195px</span>
								</div>
								...
								<div class="form-group">
									...
									<span class="form_tips" style="color:red;">可不填。（图片文件大小不能超过3M,建议上传大尺寸的图片。） 图片宽度建议为750px，高度建议为300px</span>
								</div>
