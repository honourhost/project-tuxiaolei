					...
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="add_form">
						<div class="tab-content">
									...
									<select name="marketer_id" class="valid">
										<if condition="$mar">
											<volist name="marketers" id="market" key="index">
												<if condition="$market.id eq $mar['id']">
											...
											<volist name="marketers" id="market" key="index">
												<if condition="$index eq 6">
													<option value="6" selected="selected">没有</option>
													<else />
													<option value="{pigcms{$market.id}" >{pigcms{$market.name}</option>
												</if>
							...
							<div id="txtorder" class="tab-pane">
								...
								<!--
                                	作者：1067036492@QQ.COM
                                	时间：2015-11-21
                                	描述：首页推荐
                                -->
								<div class="form-group">
									<label class="col-sm-1">首页推荐：</label>
									<select name="index_tui" class="col-sm-1">
										<option value="1"  <if condition="$now_group['index_tui'] eq 1">selected="selected"</if> >开启</option>
										<option value="0" <if condition="$now_group['index_tui'] eq 0">selected="selected"</if> >关闭</option>
									</select>
									<span class="form_tips">将会在首页显示！ </span>
								</div>
