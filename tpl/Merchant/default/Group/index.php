								...
								<if condition="$group_list">
									<volist name="group_list" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td style="text-align:center;"><if condition="$vo['group_lock'] eq 0"><a style="width: 60px;" class="label label-sm label-info" title="编辑" href="{pigcms{:U('Group/edit',array('group_id'=>$vo['group_id']))}">编辑</a></if>&nbsp;<a style="width: 60px;" class="label label-sm label-info" title="评论列表" href="{pigcms{:U('Message/group_reply',array('group_id'=>$vo['group_id']))}">评论列表</a>&nbsp;<a style="width: 60px;" class="label label-sm label-info" title="订单列表" href="{pigcms{:U('Group/order_list',array('group_id'=>$vo['group_id']))}">订单列表</a>
                                                <li class="dropdown li-class" id="menu-item-2">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li class="li-class" id="menu-item-9">
                                                            <a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id={pigcms{$vo.group_id}&preview=1" target="_blank">微信端</a></li>
                                                        <li class="li-class" id="menu-item-10"><a href="http://www.xiaonongding.com/group/{pigcms{$vo.group_id}.html?preview=1" target="_blank">PC端</a></li>
                                                        <li class="li-class" id="menu-item-11"><a href="http://www.xiaonongding.com/wap.php?g=Wap&c=Group&a=detail&group_id={pigcms{$vo.group_id}&preview=1" target="_blank">APP端</a></li>
                                                 </ul>
                                                </li>
                                            </td>
                                                </tr>
