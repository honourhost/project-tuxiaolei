								...
								<volist name="order_list" id="vo">
									<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
										...
										<td class="button-column" width="40">
											<if condition="$vo.mer_id eq 726 ">
												<else/>
												<if condition="($vo['paid'] eq 0) AND ($vo['status'] neq 3)"><a title="取消订单" class="red" style="padding-right:8px;" href="{pigcms{:U('Group/order_cancle',array('order_id'=>$vo['order_id']))}">
