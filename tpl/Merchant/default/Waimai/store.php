                                ...
                                <div class="tab-content">
                                    <div id="basicinfo" class="tab-pane active">
                                    	<div class="form-group">
                                                ...
                                                <span><label><span>休息</span><input id='close_waimai' name="close_waimai" <if condition="$store['close'] eq '0' ">checked="checked"</if> value="0" type="radio"></label></span>
                                                <span><label><span>可预约</span><input id='close_waimai' name="close_waimai" <if condition="$store['close'] eq '1')" >checked="checked"</if> value="1" type="radio" ></label></span>
                                                <span><label><span>正常营业</span><input id='close_waimai' name="close_waimai" <if condition="$store['close'] eq '2' || !isset($store['close'])" >checked="checked"</if> value="1" type="radio" ></label></span>
                                        </div>
                                    	<div class="form-group">
                                                <label class="col-sm-1"><label>餐具费</label></label>
                                                <span><label><span>收取</span><input id='tools_money_have' name="tools_money_have" <if condition="$store['tools_money_have'] eq '1' || !$store['tools_money_have']">checked="checked"</if> value="1" type="radio"></label></span>
                                                <span><label><span>不收</span><input id='tools_money_have' name="tools_money_have" <if condition="$store['tools_money_have'] eq '0'">checked="checked"</if> value="0" type="radio" ></label></span>
                                        </div>
                                        <div class="form-group">
