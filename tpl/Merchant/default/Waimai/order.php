							...
							<tbody>
								...
								<volist name="order_list" id="vo">
									<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
										...
										<td width="130">
											创建时间：<br/>{pigcms{$vo.create_time|date="Y-m-d H:i:s",###}<br/>
											支付时间：<br/>{pigcms{$vo.pay_time|date="Y-m-d H:i:s",###}
										</td>
										<td width="150">
											收货码：{pigcms{$vo.code}<br/>
											预约配送时间：<br/>{pigcms{$vo.book_send_time|date="Y-m-d H:i:s",###}<br/>
											订单送达时间：<br/>{pigcms{$vo.order_send_time|date="Y-m-d H:i:s",###}
										</td>
										<td width="120">
