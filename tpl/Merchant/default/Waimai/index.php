                                    ...
                                    <volist name="store_list" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <td class="button-column">
                                                <a href="{pigcms{$config.site_url}/index.php?g=Index&c=Recognition&a=see_qrcode&type=meal&id={pigcms{$vo['store_id']}" class="see_qrcode">查看</a>
                                            </td>
                                            <td class="button-column">
                                                <a style="width:80px;" title="查看店铺订单" href="{pigcms{:U('Waimai/order',array('store_id'=>$vo['store_id']))}">233</a>
                                            </td>
                                            <td class="button-column">
