								...
								<tbody>
									...
									<for start="1" end="4">
										<tr class="parent" data-index="{pigcms{$i}">
											...
											<td><input readonly name="custommenu[{pigcms{$i}][url]" type="text" class="span3 url" id="{pigcms{$i}_url" value="<if condition="isset($dlists[$i]['url'])">{pigcms{$dlists[$i]['url']}</if>">　　<a href="#modal-table" class="btn btn-sm btn-success" onclick="addLink('{pigcms{$i}_url',0)" data-toggle="modal">从功能库选择</a></td>
										</tr>
										...
										<tr class="childs_{pigcms{$i} hidden">
											...
											<td>
												...
												<input readonly name="custommenu[{pigcms{$i * 10 + $k}][id]" type="hidden" class="span2 id" id="{pigcms{$i * 10 + $k}_id" value="<if condition="isset($dlists[$i]['list'][$k]['id'])">{pigcms{$dlists[$i]['list'][$k]['id']}</if>">
											</td>
											<td>
											...
											<td><input readonly name="custommenu[{pigcms{$i * 10 + $k}][url]" type="text" class="span2 url" id="{pigcms{$i * 10 + $k}_url" value="<if condition="isset($dlists[$i]['list'][$k]['url'])">{pigcms{$dlists[$i]['list'][$k]['url']}</if>">　　<a href="#modal-table" class="btn btn-sm btn-success" onclick="addLink('{pigcms{$i * 10 + $k}_url',0)" data-toggle="modal">从功能库选择</a></td>
										</tr>
										</for>
									</for>
								</tbody>
