						...
						<div class="tab-content">
							...
							<div id="txtnum" class="tab-pane">
								...
								<div class="form-group">
									...
									<input class="col-sm-1"  name="remarks" type="text" value="{pigcms{$now_group.remarks}"><span class="form_tips">特卖备注信息</span>
								</div>
							</div>
							<div id="txtorder" class="tab-pane">
								...
								<div class="form-group">
									...
									<span class="form_tips">将会在首页显示！{pigcms{$now_group.index_tui}</span>
								</div>
