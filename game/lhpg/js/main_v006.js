...
function share(){
    ...
    var _pic = "http://game.weixine.net/lhpg/icon.jpg";
    ...
    if( stage == 'android' || stage == 'ios' ){
	    ...
	    window.location = "http://game.weixine.net/index.html?c=share&a=index&url=_url&title=" + _title + "&pic=" + _pic + "&line1=";
    }
}        
...
var onBridgeReady = function() {
		...
		WeixinJSBridge.on('menu:share:timeline', function(argv) {
			var wxTitle = "",
				...
				_imgurl = 'http://game.weixine.net/lhpg/icon.jpg',
